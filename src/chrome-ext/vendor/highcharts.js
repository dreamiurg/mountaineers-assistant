!(
   ...
   */ (function (t, e) {
    ...
    (() => {
      ...
      ;(v.d = (t, e) => {
        for (var i in e)
          v.o(e, i) && !v.o(t, i) && Object.defineProperty(t, i, { enumerable: !0, get: e[i] })
      }),
 ...
 - ${i}: ${e}`),
        ...
        U(w, 'displayError', { chart: i, code: t, message: a, params: s }, function () {
          if (e) throw Error(a)
      ...
      function U(t, e, i, s) {
        if (((i = i || {}), S?.createEvent && (t.dispatchEvent || (t.fireEvent && t !== w)))) {
      ...
      T.jQuery &&
        (T.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return t[0]
              ? (new w[P(t[0]) ? t.shift() : 'Chart'](this[0], t[0], t[1]), this)
      ...
      let V = {
          addEvent: function (t, e, i, s = {}) {
            ...
            a &&
              a.call(
                ...
                e,
                i,
                !!w.supportsPassiveEvents && {
                  passive: void 0 === s.passive ? -1 !== e.indexOf('touch') : s.passive,
                  capture: !1,
                }
              ),
              r[e] || (r[e] = [])
            let n = { fn: i, order: 'number' == typeof s.order ? s.order : 1 / 0 }
            return (
              r[e].push(n),
          ...
          createElement: function (t, e, i, s, o) {
            ...
            return (
              e && R(r, e),
              o && H(r, { padding: '0', border: 'none', margin: '0' }),
              i && H(r, i),
              s && s.appendChild(r),
              r
            )
          ...
          extendClass: function (t, e) {
            let i = function () {}
            return (i.prototype = new t()), R(i.prototype, e), i
          },
          find: G,
          fireEvent: U,
          getAlignFactor: (t = '') => ({ center: 0.5, right: 1, middle: 0.5, bottom: 1 })[t] || 0,
          ...
          getStyle: function t(e, i, s) {
            ...
            return r && ((o = r.getPropertyValue(i)), W(s, 'opacity' !== i) && (o = A(o))), o
          },
          insertItem: function (t, e) {
            ...
            for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
              if (
                !e[i] ||
                (D(s) && s < W(e[i].options.index, e[i]._i)) ||
              ...
              r = function (t, e) {
                return (
                  ...
                  j(e, function (i, s) {
                    '__proto__' !== s &&
                      'constructor' !== s &&
                      (!O(i, !0) || I(i) || E(i) ? (t[s] = e[s]) : (t[s] = r(t[s] || {}, i)))
                  }),
                  t
                )
              }
          ...
          normalizeTickInterval: function (t, e, i, s, o) {
            ...
            return F(a * i, -Math.round(Math.log(0.001) / Math.LN10))
          },
          objectEach: j,
          offset: function (t) {
        ...
        td = class {
          ...
          update(t = {}) {
            ;(this.dTLCache = {}), (this.options = t = ti(!0, this.options, t))
            ...
            if (!o) {
              ...
              try {
                ...
                ;/Invalid time zone/i.test(e.message)
                  ? (K(34), (t.timeZone = 'UTC'), (o = new Intl.DateTimeFormat(i, t)))
                  : K(e.message, !1)
              }
            }
          ...
          makeTime(t, e, i = 1, s = 0, o, r, a) {
            ...
            if ('UTC' !== this.timezone) {
              ...
              if (((n += t), -1 !== [2, 3, 8, 9, 10, 11].indexOf(e) && (s < 5 || s > 20))) {
                ...
                t !== e
                  ? (n += e - t)
                  : t - 36e5 !== this.getTimezoneOffset(n - 36e5) || th || (n -= 36e5)
              }
            }
            return n
          }
          parse(t) {
            if (!te(t)) return t ?? void 0
            let e =
            ...
            e || i || (t += 'Z')
            let s = Date.parse(t)
            if (Q(s)) return s + (!e || i ? this.getTimezoneOffset(s) : 0)
          }
          getTimezoneOffset(t) {
            if ('UTC' !== this.timezone) {
          ...
          dateFormat(t, e, i) {
            ...
            if (te(t) && -1 !== t.indexOf('%')) {
              ...
              let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                ...
                { prefix: o = '', suffix: r = '' } = t
              t = o + this.dateTimeFormat(J({ timeZone: s }, t), e) + r
            }
            return i ? tn(t) : t
          }
          resolveDTLFormat(t) {
        ...
        tu = class extends td {
          getTimeTicks(t, e, i, s) {
            ...
            if ((s ?? (s = 1), tc(e))) {
              if (
                ((f = h >= tg.second ? 0 : n * Math.floor(f / n)),
              ...
              ;(e = o.makeTime(l, d, c, p, g, u, f)),
                o.variableTimezone &&
                  tc(i) &&
                  (m = i - e > 4 * tg.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i))
              let t = e,
                x = 1
              for (; t < i; )
                r.push(t),
                  h === tg.year
                    ...
                    : h === tg.month
                      ...
                      : m && (h === tg.day || h === tg.week)
                        ? (t = o.makeTime(l, d, c + x * n * (h === tg.day ? 1 : 7)))
                        : m && h === tg.hour && n > 1
            ...
            return (r.info = tp(t, { higherRanks: a, totalRange: h * n })), r
          }
        },
        { isTouchDevice: tf } = w,
        ...
        ty = {
          ...
          legend: {
            ...
            x: 0,
            y: 0,
            title: { style: { color: '#333333', fontSize: '0.8em', fontWeight: 'bold' } },
          },
          loading: {
        ...
        tv = {
          ...
          setOptions: function (t) {
            return (
              tm(w, 'setOptions', { options: t }),
              tx(!0, ty, t),
              t.time && tb.update(ty.time),
              t.lang && 'locale' in t.lang && tb.update({ locale: t.lang.locale }),
              t.lang?.chartTitle && (ty.title = { ...ty.title, text: t.lang.chartTitle }),
              ty
            )
          },
        },
      ...
      class tL {
        ...
        constructor(t) {
          ...
          let r = w.Color
          if (r && r !== tL) return new r(t)
          if ('object' == typeof t && void 0 !== t.stops)
            this.stops = t.stops.map((t) => new tL(t[1]))
          else if ('string' == typeof t)
            for (
              this.input = t = tL.names[t.toLowerCase()] || t, s = tL.parsers.length;
              s-- && !i;
            )
        ...
        brighten(t) {
          ...
          if (this.stops)
            ...
            if (tw(e[0]))
              for (let i = 0; i < 3; i++)
                (e[i] += tT(255 * t)), e[i] < 0 && (e[i] = 0), e[i] > 255 && (e[i] = 255)
            else
              tL.useColorMix &&
                tP(this.input) &&
                (this.output = tA(this.input, t > 0 ? 'white' : 'black', Math.abs(t)))
          return this
        }
        setOpacity(t) {
        ...
        tweenTo(t, e) {
          let i = this.rgba,
            s = t.rgba
          if (!tw(i[0]) || !tw(s[0]))
            return tL.useColorMix && tP(this.input) && tP(t.input) && e < 0.99
              ? tA(this.input, t.input, e)
              : t.input || 'none'
          let o = 1 !== s[3] || 1 !== i[3],
            r = (t, s) => t + (i[s] - t) * (1 - e),
      ...
      ;(tL.names = { white: '#ffffff', black: '#000000' }),
        (tL.parsers = [
          {
      ...
      class tB {
        ...
        run(t, e, i) {
          let s = this,
            ...
            n = function () {
              for (let t = 0; t < tB.timers.length; t++) tB.timers[t]() || tB.timers.splice(t--, 1)
        ...
        initPath(t, e, i) {
          ...
          return (
            g.length && tI(l) && ((d = r.length + l * n), p ? (u(g, r), f(r)) : (u(r, g), f(g))),
            [g, r]
          )
        }
        fillSetter() {
      ...
      function tj(t) {
        return tH(t) ? tX({ duration: 500, defer: 0 }, t) : { duration: 500 * !!t, defer: 0 }
      }
      function tY(t, e) {
      ...
      let tU = {
          animate: function (t, e, i) {
            let s,
              ...
              a,
              n
            tH(i) || ((n = arguments), (i = { duration: n[2], easing: n[3], complete: n[4] })),
              ...
              tF(e, function (n, h) {
                tY(t, h),
                  ...
                  'd' === h && tR(e.d)
                    ...
                    : t.attr
                      ? (s = t.attr(h))
                      : ((s = parseFloat(tz(t, h)) || 0), 'opacity' !== h && (o = 'px')),
                  r || (r = n),
        ...
        { trustedTypes: t2 } = tV,
        t3 = t2 && tJ(t2.createPolicy) && t2.createPolicy('highcharts', { createHTML: (t) => t }),
        t5 = t3 ? t3.createHTML('') : ''
      class t6 {
            ...
            t0(t, (e, i) => {
              ...
              ;-1 === t6.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ['background', 'dynsrc', 'href', 'lowsrc', 'src'].indexOf(i) &&
                  (s = tQ(e) && t6.allowedReferences.some((t) => 0 === e.indexOf(t))),
                s || (tK(33, !1, void 0, { 'Invalid attribute in config': `${i}` }), delete t[i]),
                ...
                if (r)
                  if ('#text' === r) o = a
                    ...
                    t0(e, function (t, e) {
                      ...
                      t(e.children || [], h),
                      (o = h)
                  } else tK(33, !1, void 0, { 'Invalid tagName in config': r })
      ...
      function ed(t = '', e, i) {
        let s = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g,
          ...
          c = (t = '') => {
            ...
            return (
              'true' === t ||
              ('false' !== t &&
                ((i = Number(t)).toString() === t ? i : el(t) ? t.slice(1, -1) : et(t, e)))
            )
          },
          p,
          g,
        ...
        for (; null !== (p = s.exec(t)); ) {
          ...
          en[a] && (g.isBlock && a === g.fn && u++, g.fn || (g.fn = a))
          let n = 'else' === p[1]
        ...
        return (
          r.forEach((s) => {
            let r,
              p,
              { body: g, elseBody: u, expression: f, fn: m } = s
            if (m) {
              let t = [s],
                o = [],
                a = f.length,
              ...
              for (p = 0; p <= a; p++) {
                let t = f.charAt(p)
                h || ('"' !== t && "'" !== t) ? h === t && (h = '') : (h = t),
                  h || (' ' !== t && p !== a) || (o.push(f.substr(n, p - n)), (n = p + 1))
              }
              ...
              if ('number' == typeof r && (t.length || e)) {
                ...
                if (a.test(i) || e) {
                  ...
                  null !== r &&
                    (r = d(r, t, h.decimalPoint, i.indexOf(',') > -1 ? h.thousandsSep : ''))
        ...
        i ?? (i = h.decimalPoint),
          ...
          -1 === e
            ...
            : ei(e)
              ...
              : (e = 2),
          n && (e ?? (e = 2), (t = a)),
          ei(e) && e >= 0 && ((c.minimumFractionDigits = e), (c.maximumFractionDigits = e)),
          '' === s && (c.useGrouping = !1)
        let p = s || i,
          g = p ? 'en' : this?.locale || h.locale || t8,
          u = JSON.stringify(c) + g
        return (
          (o = (eh[u] ?? (eh[u] = new Intl.NumberFormat(g, c))).format(t)),
          p &&
            (o = o
              .replace(/([,\.])/g, '_$1')
              .replace(/_\,/g, s ?? ',')
      ...
      !(function (t) {
        ...
        ;(t.rendererTypes = {}),
          ...
          (t.registerRendererType = function (i, s, o) {
            ;(t.rendererTypes[i] = s), (!e || o) && ((e = i), (w.Renderer = s))
          })
      })(s || (s = {}))
      let eg = s,
      ...
      ;(o || (o = {})).distribute = function t(e, i, s) {
        ...
        for (
          ex(e, a),
            e = e.map((t) => ({ size: t.size, targets: [t.target], align: ef(t.align, 0.5) }));
          u;
        ) {
          for (c = e.length; c--; )
            (f = e[c]),
      ...
      class eK {
        ...
        applyTextOutline(t) {
          ...
          if (o && 'none' !== o && w.svg) {
            ...
            ;(a.textContent = '​'),
              eL(a, { x: Number(e.getAttribute('x')), dy: -r }),
              t.appendChild(a),
        ...
        clip(t) {
          if (t && !t.clipPath) {
            ...
            eN(t, { clipPath: i, id: e, count: 0 }), t.add(i)
          }
        ...
        crisp(t, e) {
          ...
          let i = t.x || this.x || 0,
            ...
            n = eE(s, e)
          return (
            eN(t, { x: a, y: n, width: eE(o, e) - a, height: eE(r, e) - n }),
          ...
          ez(this.renderer, 'complexColor', { args: arguments }, function () {
            if (
              ...
              if (
                ...
                eW(a) &&
                  (t[r] = a =
                    { x1: a[0], y1: a[1], x2: a[2], y2: a[3], gradientUnits: 'userSpaceOnUse' }),
                'radialGradient' === r &&
                  p &&
                  !eD(a.gradientUnits) &&
                  ((n = a),
                  (a = ej(a, s.getRadialAttr(p, n), { gradientUnits: 'userSpaceOnUse' }))),
                eY(a, function (t, e) {
                  'id' !== e && u.push(e, t)
                }),
                eY(l, function (t) {
                ...
                ;(t.radAttr = n),
                  ...
                  l.forEach(function (e) {
                    0 === e[1].indexOf('rgba')
                      ? ((d = (o = tL.parse(e[1])).get('rgb')), (c = o.get('a')))
                      : ((d = e[1]), (c = 1))
                    let i = s
                      .createElement('stop')
        ...
        css(t) {
          ...
          if (
            ...
            s.namespaceURI === this.SVG_NS &&
              ...
              a.color && ((a.fill = a.color), delete a.color)),
              eI(s, a)
          }
          return (
            this.added &&
        ...
        dashstyleSetter(t) {
          ...
          if (('inherit' === i && (i = 1), t)) {
            let s = (t = t.toLowerCase())
              ...
              .replace(/,$/, '')
              .split(',')
            for (e = s.length; e--; ) s[e] = '' + e$(s[e]) * eU(i, NaN)
        ...
        getBBox(t, e) {
          let i,
            ...
            o,
            r,
            { alignValue: a, element: n, renderer: h, styles: l, textStr: d } = this,
            { cache: c, cacheKeys: p } = h,
            g = n.namespaceURI === this.SVG_NS,
            u = eU(e, this.rotation, 0),
            f = h.styledMode ? n && eK.prototype.getStyle.call(n, 'font-size') : l.fontSize
          if (
            (eD(d) &&
            ...
            if (g || h.forExport) {
              try {
                ;(o =
                  ...
                  (i = n.getBBox
                    ? eN({}, n.getBBox())
                    : { width: n.offsetWidth, height: n.offsetHeight, x: 0, y: 0 }),
                  eH(o) && o('')
              } catch {}
            ...
            ;(s = i.height),
              g &&
                (i.height = s =
                  { '11px,17': 14, '13px,20': 16 }[`${f || ''},${Math.round(s)}`] || s),
        ...
        constructor(t, e) {
          ;(this.onEvents = {}),
            ...
            (this.SVG_NS = eT),
            (this.element =
              'span' === e || 'body' === e ? eO(e) : eM.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            ez(this, 'afterInit')
        }
        on(t, e) {
          let { onEvents: i } = this
          return i[t] && i[t](), (i[t] = eP(this.element, t, e)), this
        }
        opacitySetter(t, e, i) {
        ...
        shadow(t) {
          let { renderer: e } = this,
            i = ej(
              this.parentGroup?.rotation === 90 ? { offsetX: -1, offsetY: -1 } : {},
              eF(t) ? t : {}
            ),
        ...
        strokeWidth() {
          ...
          return (
            /px$/.test(t)
              ? (e = e$(t))
              : '' !== t &&
                (eL((i = eM.createElementNS(eT, 'rect')), { width: t, 'stroke-width': 0 }),
            ...
            r &&
              (g.push(
                'rotate(' +
                  r +
                  ' ' +
                  (a ?? e.getAttribute('x') ?? this.x ?? 0) +
                  ' ' +
                  (n ?? e.getAttribute('y') ?? this.y ?? 0) +
                  ')'
              ),
              d?.element.tagName !== 'SPAN' ||
                d?.foreignObject ||
                d.attr({
                  rotation: r,
        ...
        zIndexSetter(t, e) {
          ...
          if (
            (eD(t)
              ...
              : eD(this[e]) && r.removeAttribute('data-z-index'),
            (this[e] = t),
            p)
          ) {
            for (
              (t = this.zIndex) && s && (s.handleZ = !0), g = (n = o.childNodes).length - 1;
              g >= 0 && !d;
              g--
            )
      ...
      ;(eK.symbolCustomAttribs = [
        ...
        (eK.prototype.matrixSetter =
          eK.prototype.rotationOriginXSetter =
          eK.prototype.rotationOriginYSetter =
          eK.prototype.rotationSetter =
          eK.prototype.scaleXSetter =
          eK.prototype.scaleYSetter =
          eK.prototype.translateXSetter =
          eK.prototype.translateYSetter =
          eK.prototype.verticalAlignSetter =
            function (t, e) {
      ...
      class e9 extends eJ {
        ...
        alignSetter(t) {
          ...
          ;(this.textAlign = t),
            e !== this.alignFactor &&
              ((this.alignFactor = e),
              this.bBox && e2(this.xSetting) && this.attr({ x: this.xSetting }))
        }
        anchorXSetter(t, e) {
          ;(this.anchorX = t),
        ...
        onAdd() {
          this.text.add(this),
            this.attr({ text: e5(this.textStr, ''), x: this.x || 0, y: this.y || 0 }),
            this.box &&
              eQ(this.anchorX) &&
        ...
        updateBoxSize() {
          let t,
            ...
            s = this.padding,
            o = (this.bBox =
              (!e2(this.widthSetting) || !e2(this.heightSetting) || this.textAlign) && eQ(e.textStr)
                ? e.getBBox(void 0, 0)
                : e9.emptyBBox)
        ...
        updateTextPadding() {
          ...
          if (!t.textPath) {
            ...
            let i = this.baseline ? 0 : this.baselineOffset,
              s =
                (this.paddingLeft ?? this.padding) + e1(e) * (this.widthSetting ?? this.bBox.width)
            ;(s !== t.x || i !== t.y) &&
      ...
      ;(e9.emptyBBox = { width: 0, height: 0, x: 0, y: 0 }),
        (e9.textProps = [
          'color',
          'direction',
          'fontFamily',
      ...
      function it(t, e, i, s, o) {
        ...
        if (o) {
          ...
          ;(b.params = { start: a, end: n, cx: t, cy: e }),
            ...
            e4(p) &&
              (((b = [
                ...
                0,
                y,
                e4(o.clockwise) ? 1 - o.clockwise : 0,
                t + p * u,
                e + p * f,
              ]).params = { start: n, end: a, cx: t, cy: e }),
      ...
      let is = {
          ...
          callout: function (t, e, i, s, o) {
            let r = Math.min(o?.r || 0, i, s),
              ...
              h = o?.anchorY || 0,
              l = ii(t, e, i, s, { r })
            if (!e8(n) || (n < i && n > 0 && h < s && h > 0)) return l
            if (t + n > i - a)
              if (h > e + a && h < e + s - a)
                l.splice(
                  3,
              ...
              h > s && n < i - a
                ...
                : h < 0 &&
                  n > a &&
                  l.splice(1, 1, ['L', n - 6, e], ['L', n, e - 6], ['L', n + 6, e], ['L', i - r, e])
            return l
          },
        ...
        im = class {
          ...
          modifyDOM() {
            ...
            ;[].forEach.call(e.element.querySelectorAll('tspan.highcharts-br'), (t, s) => {
              t.nextSibling &&
                ...
                ih(t, { dy: this.getLineHeight(t.nextSibling), x: i }))
            })
            let s = this.width || 0
            if (!s) return
            let o = (t, o) => {
                ...
                if (n) {
                  ...
                  for (; a.length; )
                    if (
                      ...
                      a.length &&
                        (this.truncate(t, t.textContent || '', void 0, 0, s, l, iu),
          ...
          modifyTree(t) {
            let e = (i, s) => {
              ...
              '#text' !== n && 'a' !== n && (i.tagName = 'tspan'),
                il(i, { attributes: o, style: a }),
                r && r.filter((t) => '#text' !== t.tagName).forEach(e)
            }
            t.forEach(e), id(this.svgElement, 'afterModifyTree', { nodes: t })
          }
          truncate(t, e, i, s, o, r, a) {
            ...
            if (((l.rotation = 0), s + (h = f(t.textContent.length)) > o)) {
              ...
              0 === g
                ? (t.textContent = '')
                : (e && g === e.length - 1) || (t.textContent = n || a(e || i, u)),
          ...
          unescapeEntities(t, e) {
            return (
              ip(this.renderer.escapes, function (i, s) {
      ...
      class iU {
        constructor(t, e, i, s, o, r, a) {
          let n, h
          ;(this.x = 0), (this.y = 0)
          let l = this.createElement('svg').attr({ version: '1.1', class: 'highcharts-root' }),
            d = l.element
          a || l.css(this.getStyle(s || {})),
            ...
            this.createElement('desc')
              .add()
              .element.appendChild(iv.createTextNode('Created with Highcharts 12.4.0')),
        ...
        getReferenceURL() {
          if ((ik || iM) && iv.getElementsByTagName('base').length) {
            if (!iD(e)) {
              ...
              iI(i, { position: 'fixed', top: 0, left: 0, zIndex: 9e5 })
              let s = iv.elementFromPoint(6, 6)
              ;(e = s?.id === 'hitme'), iv.body.removeChild(i)
            }
            if (e)
              return ij(
                iA.location.href.split('#')[0],
                [/<[^>]*>/g, ''],
                [/([\('\)])/g, '\\$1'],
                [/ /g, '%20']
              )
        ...
        shadowDefinition(t) {
          let e = [
              ...
              .toLowerCase()
              .replace(/[^a-z\d\-]/g, ''),
            i = iX({ color: '#000000', offsetX: 1, offsetY: 1, opacity: 0.15, width: 5 }, t)
          return (
          ...
          return (
            c ||
              ['hover', 'select', 'disabled'].forEach((t, e) => {
                m.push(iX(m[0], t6.filterUserAttributes(p[e + 5] || u[t] || {}))),
                  x.push(m[e + 1].style),
                  delete m[e + 1].style
              }),
            ...
            d.attr(m[0]),
            !c && (d.css(iN({ cursor: 'default' }, f)), l && d.text.css({ pointerEvents: 'none' })),
            d
        ...
        crispLine(t, e) {
          let [i, s] = t
          return (
            iD(i[1]) && i[1] === s[1] && (i[1] = s[1] = iE(i[1], e)),
        ...
        path(t) {
          ...
          return iz(t) ? (e.d = t) : iW(t) && iN(e, t), this.createElement('path').attr(e)
        }
        circle(t, e, i) {
          let s = iW(t) ? t : void 0 === t ? {} : { x: t, y: e, r: i },
        ...
        rect(t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a['stroke-width'] = r), iN(a, n.crisp(a))), (a.fill = 'none')),
            (n.rSetter = function (t, e, i) {
              ;(n.r = t), iL(i, { rx: t, ry: t })
            }),
            (n.rGetter = function () {
              return n.r || 0
            }),
        ...
        image(t, e, i, s, o, r) {
          ...
          if (r) {
            ...
            let e = new iA.Image()
            iP(e, 'load', h), (e.src = t), e.complete && h({})
          } else n.attr({ href: t })
          return n
        }
        symbol(t, e, i, s, o, r) {
          ...
          if (u)
            'number' == typeof e && (n = u.call(this.symbols, e || 0, i || 0, s || 0, o || 0, r)),
              ...
              iN(a, { symbolName: g || void 0, x: e, y: i, width: s, height: o }),
              r && iN(a, r)
          else if (p) {
            h = t.match(c)[1]
            let s = (a = this.image(h))
            ;(s.imgwidth = iF(r?.width, iC[h]?.width)),
              (s.imgheight = iF(r?.height, iC[h]?.height)),
              ...
              ['width', 'height'].forEach((t) => {
                s[`${t}Setter`] = function (t, e) {
                  ...
                  r && 'within' === r.backgroundSize && o && a && n && h
                    ? ((d = Math.min(o / n, a / h)),
                      iL(s, { width: Math.round(n * d), height: Math.round(h * d) }))
                ...
                : (s.attr({ width: 0, height: 0 }),
                  iO('img', {
                    onload: function () {
                      ...
                      0 === this.width &&
                        (iI(this, { position: 'absolute', top: '-999em' }),
                        iv.body.appendChild(this)),
                        (iC[h] = { width: this.width, height: this.height }),
        ...
        text(t, e, i, s) {
          ...
          ;(o.x = Math.round(e || 0)), i && (o.y = Math.round(i)), iD(t) && (o.text = t)
        ...
        rotCorr(t, e, i) {
          let s = t
          return (
            e && i && (s = Math.max(s * Math.cos(e * ib), 4)),
            { x: (-t / 3) * Math.sin(e * ib), y: s }
          )
        }
        pathToSegments(t) {
          let e = [],
      ...
      let i5 = (t, e) => {
        if (!t.div) {
          ...
          ;(t.classSetter = (t, e, i) => {
            ...
            (t.on = function () {
              return eJ.prototype.on.apply({ element: o, onEvents: t.onEvents }, arguments), t
            }),
            (t.div = o)
        }
        return t.div
      ...
      class i6 extends eJ {
        static compose(t) {
          i2(i$, this.compose) &&
            (t.prototype.html = function (t, e, i) {
              return new i6(this, 'span').attr({ text: t, x: Math.round(e), y: Math.round(i) })
            })
        }
        constructor(t, e) {
          super(t, e),
        ...
        css(t) {
          let e,
            ...
            o = s && t.width
          return (
            s && (delete t.width, (this.textWidth = i1(o) || void 0), (e = !0)),
        ...
        updateTransform() {
          ...
          let {
            ...
            scaleX: n,
            scaleY: h,
            styles: { display: l = 'inline-block', whiteSpace: d },
            textAlign: c = 'left',
            textWidth: p,
            translateX: g = 0,
            translateY: u = 0,
          ...
          if ((e || i_(t, { marginLeft: `${g}px`, marginTop: `${u}px` }), 'SPAN' === t.tagName)) {
            let g,
              u = [o, c, t.innerHTML, p, this.textAlign].join(','),
              x = -(this.parentGroup?.padding * 1) || 0
            if (p !== i) {
              let e = this.textPxLength
                  ? this.textPxLength
                  : (i_(t, { width: '', whiteSpace: d || 'nowrap' }), t.offsetWidth),
                r = p || 0,
            ...
            e &&
              (i_(t, { display: 'inline-block', verticalAlign: 'top' }),
              ...
              u !== this.cTT &&
                ...
                iK(o) &&
                  ...
                  i_(t, { transform: `rotate(${o}deg)`, transformOrigin: `${x}% ${x}px` }),
                this.getSpanCorrection(
                  (!iK(o) && !this.textWidth && this.textPxLength) || t.offsetWidth,
                  g,
                  iQ(c)
                ))
                ...
                ? (super.updateTransform(),
                  i0(f) && i0(m)
                    ? (e.attr({
                      ...
                      i_(t, { display: l, textAlign: c }))
                    : iV && e.attr({ width: 0, height: 0 }))
                : i_(t, v),
              (this.cTT = u),
              (this.oldRotation = o),
              (this.oldAlign = c)
        ...
        add(t) {
          ...
          if (e)
            ...
            if (((this.parentGroup = t), t && !(e = t.div))) {
              ...
              for (let t of o.reverse()) e = i5(t, s)
            }
      ...
      ;(i9.visibilitySetter = i9.opacitySetter = i3),
        (i9.ySetter =
          i9.rotationSetter =
          i9.rotationOriginXSetter =
          i9.rotationOriginYSetter =
            i9.xSetter),
        !(function (t) {
          ;(t.xAxis = {
            alignTicks: !0,
      ...
      ;(a || (a = {})).registerEventOptions = function (t, e) {
        ;(t.eventOptions = t.eventOptions || {}),
          st(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] && (se(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
              i7(e) && ((t.eventOptions[i] = e), i8(t, i, e, { order: 0 })))
          })
      }
      let si = a,
        { deg2rad: ss } = w,
        ...
        sf = class {
          ...
          addLabel() {
            let t = this,
              ...
              a = e.names,
              n = t.pos,
              h = su(t.options?.labels, i.labels),
              l = e.tickPositions,
              d = n === l[0],
              c = n === l[l.length - 1],
              ...
              e.dateTime &&
                (g
                  ? (f = (m = s.time.resolveDTLFormat(
                      i.dateTimeLabelFormats[(!i.grid?.enabled && g.higherRanks[n]) || g.unitName]
                    )).main)
                  : sc(y) && (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
              (t.isFirst = d),
              (t.isLast = c)
            let b = {
              axis: e,
            ...
            let v = (t) =>
                h.formatter
                  ...
                  : h.format
                    ? ((t.text = e.defaultLabelFormatter.call(t)), ep.format(h.format, t, s))
            ...
            w
              ...
              sa(u) || t.movedLabel
                ? u &&
                  u.textStr !== k &&
                  !p &&
                  (!u.textWidth || h.style.width || u.styles.width || u.css({ width: null }),
                  u.attr({ text: k }),
          ...
          getPosition(t, e, i, s) {
            let o = this.axis,
              ...
              n = {
                x: t
                  ? sr(o.translate(e + i, void 0, void 0, s) + o.transB)
                  : o.left +
                    o.offset +
                    (o.opposite ? ((s && r.oldChartWidth) || r.chartWidth) - o.right - o.left : 0),
                y: t
                  ? a - o.bottom + o.offset - (o.opposite ? o.height : 0)
                  : sr(a - o.translate(e + i, void 0, void 0, s) - o.transB),
              }
            return (n.y = so(n.y, -1e9, 1e9)), sl(this, 'afterGetPosition', { pos: n }), n
          }
            ...
            return (
              (h =
                0 === d.side
                  ...
                  : 2 === d.side
                    ? u.y + m
                    : Math.cos(i.rotation * ss) * (u.y - i.getBBox(!1, 0).height / 2)),
              sa(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
              (t =
                t +
                su(o.x, [0, 1, 0, -1][d.side] * m) +
                f +
                u.x -
                (r && s ? r * c * (p ? -1 : 1) : 0)),
              ...
              (x.x = t),
              (x.y = Math.round(e)),
              sl(this, 'afterGetLabelPosition', { pos: x, tickmarkOffset: r, index: a }),
              x
            )
          }
          getLabelSize() {
          ...
          handleOverflow(t) {
            let e = this.axis,
              ...
              r = e.chart.spacing,
              a = su(e.labelLeft, Math.min(e.pos, r[3])),
              n = su(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, o - r[1])),
              h = this.label,
              l = this.rotation,
              d = sd(e.labelAlign || h.attr('align')),
              c = h.getBBox().width,
            ...
            l || 'justify' !== i.overflow
              ? l < 0 && s - d * c < a
                ? (f = Math.round(s / Math.cos(l * ss) - a))
                : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * ss)))
              : (s - d * c < a
                  ? (g = t.x + g * (1 - d) - a)
                  : s + (1 - d) * c > n && ((g = n - t.x + g * d), (u = -1)),
                (g = Math.min(p, g)) < p &&
                  'center' === e.labelAlign &&
              ...
              f &&
                ...
                (this.shortenLabel
                  ? this.shortenLabel()
                  : h.css(sh({}, { width: Math.floor(f) + 'px', lineClamp: +!e.isRadial })))
          }
          moveLabel(t, e) {
            let i = this,
              s = i.label,
          ...
          renderGridLine(t, e) {
            let i = this.axis,
              ...
              r = this.pos,
              a = this.type,
              n = su(this.tickmarkOffset, i.tickmarkOffset),
              h = i.chart.renderer,
              l = this.gridLine,
              d,
              c = s.gridLineWidth,
            ...
            'minor' === this.type &&
              ...
              l ||
                (i.chart.styledMode ||
                  ((o.stroke = p), (o['stroke-width'] = c || 0), (o.dashstyle = g)),
                a || (o.zIndex = 1),
                t && (e = 0),
                (this.gridLine = l =
                  h
          ...
          replaceMovedLabel() {
            let t = this.label,
              e = this.axis
            t && !this.isNew && (t.animate({ opacity: 0 }, void 0, t.destroy), delete this.label),
              (e.isDirty = !0),
        ...
        sU = (t, e) =>
          sW(
            ...
            void 0,
            void 0,
            sX(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount),
            !!t.tickAmount
          )
      ...
      class s$ {
        ...
        init(t, e, i = this.coll) {
          ...
          ;(this.chart = t),
            ...
            (this.isXAxis = s),
            (this.coll = i),
            sE(this, 'init', { userOptions: e }),
            (this.opposite = sX(e.opposite, this.opposite)),
            (this.side = sX(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3)),
            this.setOptions(e)
          let r = this.options,
            a = r.labels
          this.type ?? (this.type = r.type || 'linear'),
            ...
            (this.reversed = sX(r.reversed, this.reversed)),
        ...
        setOptions(t) {
          ...
          ;(this.options = sR(
            ...
            sE(this, 'afterSetOptions', { userOptions: t })
        }
        defaultLabelFormatter() {
          let t = this.axis,
            { numberFormatter: e } = this.chart,
            i = sN(this.value) ? this.value : NaN,
            s = t.chart.time,
            o = t.categories,
                ...
                if (i.reserveSpace()) {
                  ...
                  if (
                    ...
                    (o = i.getColumn('x')).length &&
                      ...
                      sN(a) ||
                        a instanceof Date ||
                        ((o = o.filter(sN)), (a = (t = i.getXExtremes(o)).min), (n = t.max)),
                      o.length &&
                        ((e.dataMin = Math.min(sX(e.dataMin, a), a)),
                        (e.dataMax = Math.max(sX(e.dataMax, n), n))))
                  else {
                    let t = i.applyExtremes()
                    sN(t.dataMin) && ((a = t.dataMin), (e.dataMin = Math.min(sX(e.dataMin, a), a))),
                      sN(t.dataMax) &&
                        ((n = t.dataMax), (e.dataMax = Math.max(sX(e.dataMax, n), n))),
                      sC(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
          let e = this,
            ...
            x
          function y(t, e, i) {
            return 'pass' !== p && (t < e || t > i) && (p ? (t = sS(t, e, i)) : (x = !0)), t
          }
          let b = {
            value: a,
            lineWidth: n,
          ...
          return (
            sE(this, 'getPlotLinePath', b, function (t) {
              ;(g = f = (c = sS((c = sX(c, e.translate(a, void 0, void 0, r))), -1e9, 1e9)) + d),
                (u = m = h - c - d),
                sN(c)
                  ? e.horiz
                    ? ((u = o),
        ...
        getLinearTickPositions(t, e, i) {
          let s,
            o,
            r,
            a = sT(Math.floor(e / t) * t),
            n = sT(Math.ceil(i / t) * t),
            h = []
          if ((sT(a + t) === a && (r = 20), this.single)) return [e]
          for (s = a; s <= n && (h.push(s), (s = sT(s + t, r)) !== o); ) o = s
          return h
        }
        getMinorTickInterval() {
          let { minorTicks: t, minorTickInterval: e } = this.options
          return !0 === t ? sX(e, 'auto') : !1 !== t ? e : void 0
        }
        ...
        adjustForMinRange() {
          ...
          this.isXAxis &&
            ...
            !e &&
            (r =
              sC(t.min) || sC(t.max) || sC(t.floor) || sC(t.ceiling)
                ? null
                : Math.min(
                    5 *
                      (sI(
            ...
            sN(s) &&
              ...
              (s = sM(l)) - o < r &&
                ((h[0] = s - r), (h[1] = i.parse(t.min) ?? s - r), (o = sw(h)))),
            (this.minRange = r),
            (this.min = o),
            (this.max = s)
        }
        getClosest() {
          ...
          if (this.categories) e = 1
            ...
            this.series.forEach(function (t) {
              ...
              1 === o.length
                ? i.push(o[0])
                : t.sorted && sC(s) && t.reserveSpace() && (e = sC(e) ? Math.min(e, s) : s)
            }),
              i.length && (i.sort((t, e) => t - e), (t = sI([i])))
          }
        ...
        setTickInterval(t) {
          let {
            ...
            d = i.time,
            c = sN(this.threshold) ? this.threshold : void 0,
            p = this.minRange || 0,
            { ceiling: g, floor: u, linkedTo: f, softMax: m, softMin: x } = h,
            y = sN(f) && i[this.coll]?.[f],
            b = h.tickPixelInterval,
            v = h.maxPadding,
            k = h.minPadding,
            w = 0,
            M,
            S = sN(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0,
            T,
            C,
            A,
            P
          if (
            ...
            (A = sX(this.userMin, d.parse(h.min))),
            (P = sX(this.userMax, d.parse(h.max))),
            y
              ? ((this.linkedParent = y),
                (M = y.getExtremes()),
                (this.min = sX(M.min, M.dataMin)),
                (this.max = sX(M.max, M.dataMax)),
                this.type !== y.type && sL(11, !0, i))
              : (l &&
                  sC(c) &&
                  sN(s) &&
                  sN(o) &&
            ...
            sN(this.max) &&
              ...
              (n &&
                (this.positiveValuesOnly &&
                  !t &&
                  0 >= Math.min(this.min, sX(o, this.min)) &&
                  sL(10, !0, i),
                (this.min = sT(n.log2lin(this.min), 16)),
                (this.max = sT(n.log2lin(this.max), 16))),
              this.range &&
                sN(o) &&
                ((this.userMin = this.min = A = Math.max(o, this.minFromRange() || 0)),
            ...
            if (
              (!sN(this.userMin) && sN(x) && x < this.min && (this.min = A = x),
              ...
              e ||
                ...
                y ||
                ((w = this.max - this.min) &&
                  (!sC(A) && k && (this.min -= w * k), !sC(P) && v && (this.max += w * v))),
            ...
            !i.polar &&
              this.min > this.max &&
              (sC(h.min) ? (this.max = this.min) : sC(h.max) && (this.min = this.max)),
              (w = this.max - this.min)
          }
          if (
            (this.min !== this.max && sN(this.min) && sN(this.max)
              ? y && !S && b === y.options.tickPixelInterval
                ? (this.tickInterval = S = y.tickInterval)
                : (this.tickInterval = sX(
                    S,
                    this.tickAmount ? w / Math.max(this.tickAmount - 1, 1) : void 0,
            ...
            this.series.forEach(function (e) {
              ...
              sE(this, 'postProcessData', { hasExtremesChanged: t })
          }
        ...
        setTickPositions() {
          ...
          if (
            ...
            if (
              ...
              (n = [this.min, this.max]), sL(19, !1, this.chart)
            ...
            n.length > this.len && (n = [n[0], n[n.length - 1]])[0] === n[1] && (n.length = 1),
              i && ((this.tickPositions = n), (h = i.apply(this, [this.min, this.max])) && (n = h))
          }
        ...
        adjustTickAmount() {
          let t = this,
            ...
            p = t.tickInterval,
            g,
            u = () => r.push(sT(r[r.length - 1] + p)),
            f = () => r.unshift(sT(r[0] - p))
          if (
            (sN(n) &&
        ...
        setExtremes(t, e, i = !0, s, o) {
          ...
          this.series.forEach((t) => {
            ...
            (t = r.time.parse(t)),
            (e = r.time.parse(e)),
            sE(this, 'setExtremes', (o = sO(o, { min: t, max: e })), (t) => {
              ;(this.userMin = t.min),
                (this.userMax = t.max),
                (this.eventArgs = t),
                i && r.redraw(s)
        ...
        setAxisSize() {
          let t = this.chart,
            ...
            r = (this.height = Math.round(
              sF(sX(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)
            )),
        ...
        autoLabelAlign(t) {
          let e = (sX(t, 0) - 90 * this.side + 720) % 360,
            i = { align: 'center' }
          return (
            sE(this, 'autoLabelAlign', i, function (t) {
        ...
        unsquish() {
          ...
          if (i) {
            if (
              (!t.staggerLines &&
                (sN(r) ? (p = [r]) : o < t.autoRotationLimit && (p = t.autoRotation)),
              p)
            ) {
              let t, e
              for (let i of p)
                (i === r || (i && i >= -90 && i <= 90)) &&
                  (e = (t = h(Math.abs(a / Math.sin(sk * i)))) + Math.abs(i / 360)) < c &&
                  ((c = e), (d = i), (l = t))
            }
          } else l = h(0.75 * a)
          return (
            (this.autoRotation = p), (this.labelRotation = sX(d, sN(r) ? r : 0)), t.step ? s : l
          )
        }
        getSlotWidth(t) {
          let e = this.chart,
        ...
        renderUnsquish() {
          ...
          sz(o.rotation) || (l.rotation = o.rotation || 0),
            ...
            this.autoRotation
              ...
              : n && (p = h),
            l.rotation && ((p = u > 0.5 * t.chartHeight ? 0.33 * t.chartHeight : u), c || (g = 1)),
              ...
              i &&
                ...
                e.shortenLabel
                  ...
                  : p &&
                    ...
                    ? i.css(sO(a, { width: `${p}px`, lineClamp: g }))
        ...
        addTitle(t) {
          ...
          this.axisTitle ||
            ...
            a || r.style.width || this.isRadial || this.axisTitle.css({ width: this.len + 'px' }),
        ...
        getOffset() {
          let t = this,
            { chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n } = t,
          ...
          if (
            ...
            d?.text &&
              ...
              m &&
                ...
                (b = sC((y = d.offset)) ? 0 : sX(d.margin, i ? 5 : 10)))),
            t.renderLine(),
            (t.offset = f * sX(s.offset, g[o] ? g[o] + (s.margin || 0) : 0)),
            (t.tickRotCorr = t.tickRotCorr || { x: 0, y: 0 }),
            (w = 0 === o ? -t.labelMetrics().h : 2 === o ? t.tickRotCorr.y : 0),
            (k = Math.abs(v) + b),
            v &&
              ((k -= w),
              (k += f * (i ? sX(c.y, t.tickRotCorr.y + f * c.distance) : sX(c.x, f * c.distance)))),
            (t.axisTitleMargin = sX(y, k)),
        ...
        getTitlePosition(t) {
          let e = this.horiz,
            ...
            g = { low: a + (e ? 0 : o), middle: a + o / 2, high: a + (e ? o : 0) }[r.align],
            u =
              (e ? s + this.height : i) +
          ...
          return sE(this, 'afterGetTitlePosition', { titlePosition: f }), f
        }
        renderMinorTick(t, e) {
          ...
          if (i.hasData() || n) {
            ...
            i.minorTickInterval &&
              ...
              h.length &&
                ...
                m &&
                  (0 === i.min || i.single) &&
                  (d[-1] || (d[-1] = new sf(i, -1, null, !0)), d[-1].render(-1))),
              u &&
                h.forEach(function (r, a) {
                  ;(e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m),
                    a % 2 == 0 &&
                      r < i.max &&
                      e <= i.max + (s.polar ? -m : m) &&
                      (p[r] || (p[r] = new w.PlotLineOrBand(i, {})),
                      (t = r + m),
                      (p[r].options = {
        ...
        drawCrosshair(t, e) {
          let i = this.crosshair,
            ...
            l
          if (
            (sE(this, 'drawCrosshair', { e: t, point: e }),
            t || (t = this.cross?.e),
            i && !1 !== (sC(e) || !s))
          ) {
            if (
              ...
              sC(a) &&
                ((l = { value: e && (this.isXAxis ? e.x : sX(e.stackY, e.y)), translatedValue: a }),
                o.polar &&
                  sO(l, { isCrosshair: !0, chartX: t?.chartX, chartY: t?.chartY, point: e }),
              ...
              h ||
                ((this.cross = h =
                  o.renderer
                    ...
                    .attr({ zIndex: sX(i.zIndex, 2) })
                    .add()),
                !o.styledMode &&
                  (h
                    .attr({
                      stroke:
                        i.color || (n ? tL.parse('#ccd3ff').setOpacity(0.25).get() : '#cccccc'),
          ...
          sE(this, 'afterDrawCrosshair', { e: t, point: e })
        }
        hideCrosshair() {
        ...
        class s {
          ...
          normalizeTimeTickInterval(t, e) {
            ...
            for (
              ...
              ((o = sq[(s = i[a])[0]]),
              (r = s[1]),
              !i[a + 1] || !(t <= (o * r[r.length - 1] + sq[i[a + 1][0]]) / 2));
              a++
            );
        ...
        t.compose = function (t) {
          return (
            t.keepProps.includes('logarithmic') ||
              (t.keepProps.push('logarithmic'), sJ(t, 'afterSetType', e), sJ(t, 'afterInit', i)),
            t
          )
        }
        class s {
          ...
          getLogTickPositions(t, e, i, s) {
            ...
            if ((s || (this.minorAutoInterval = void 0), t >= 0.5))
              ...
              ;(t = sQ(
                (t = s0('auto' === d ? null : d, this.minorAutoInterval, ((l - h) * c) / (p || 1)))
              )),
      ...
      !(function (t) {
        ...
        function r(t, e, i) {
          ...
          let s = this.getPlotLinePath({ value: e, force: !0, acrossPanes: i.acrossPanes }),
            ...
            n = this.getPlotLinePath({ value: t, force: !0, acrossPanes: i.acrossPanes }),
            h,
            l = 1,
            d
          if (n && s)
        ...
        function n(t) {
          ...
          if (e) {
            ...
            ;[i.plotLines || [], s.plotLines || [], i.plotBands || [], s.plotBands || []].forEach(
              function (e) {
                for (o = e.length; o--; ) e[o]?.id === t && s2(e, e[o])
              }
            )
          }
        }
      ...
      class oa {
        ...
        render() {
          ...
          let { axis: t, options: e } = this,
            ...
            v = s7(p),
            k = !m,
            w = { class: 'highcharts-plot-' + (b ? 'band ' : 'line ') + (e.className || '') },
            M = b ? 'bands' : 'lines'
          if (
            (!t.chart.styledMode &&
              (v
        ...
        renderLabel(t, e, i, s) {
          ...
          let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
            ...
            c = s8(l),
            p = s4(h) - d
          n.align(t, !1, { x: d, y: c, width: p, height: s4(l) - c }),
            (n.alignAttr.y -= r.fontMetrics(n).b),
            (!n.alignValue || 'left' === n.alignValue || s7(a)) &&
              n.css({
                width:
                  (t.style?.width ||
                    (i && a
                      ...
                      : 90 === n.rotation
                        ...
                        : (t.clip ? o.width : o.chart.chartWidth) - (n.alignAttr.x - o.left))) +
                  'px',
              }),
            n.show(!0)
        }
      ...
      class oO {
        ...
        destroy() {
          this.label && (this.label = this.label.destroy()),
            ...
            this.renderer && ((this.renderer = this.renderer.destroy()), ox(this.container)),
        ...
        getClassName(t, e, i) {
          ...
          return [
            ...
            !i && 'highcharts-color-' + oC(t.colorIndex, o.colorIndex),
            r?.className,
          ]
            .filter(oS)
            .join(' ')
        ...
        getLabel({ anchorX: t, anchorY: e } = { anchorX: 0, anchorY: 0 }) {
          ...
          return a && !a.parentElement && w.doc.body.appendChild(a), this.label
        }
        getPlayingField() {
        ...
        refresh(t, e) {
          ...
          r &&
            this.allowShared &&
            (o.applyInactiveState(a), a.forEach((t) => t.setState('hover')), (n.points = a)),
            (this.len = a.length)
          let f = oS(h) ? oh(h, n, i) : l.call(n, this)
          n.points = void 0
          let m = n.series
          if (((this.distance = oC(m.tooltipOptions.distance, 16)), !1 === f)) this.hide()
          else {
            if (this.split && this.allowShared) this.renderSplit(f, a)
              ...
              let t = g,
                r = u
              if (
                (e && o.isDirectTouch && ((t = e.chartX - i.plotLeft), (r = e.chartY - i.plotTop)),
                !(
                  i.polar ||
                  !1 === m.options.clip ||
                  a.some((e) => o.isDirectTouch || e.series.shouldShowTooltip(t, r))
                ))
              )
                return void this.hide()
              {
                ...
                ;(!s.style.width || d) &&
                  ...
                  t.attr({ class: this.getClassName(n), text: f && f.join ? f.join('') : f }),
                  this.outside &&
                    t.attr({
                      x: of(t.x || 0, 0, this.getPlayingField().width - (t.width || 0) - 1),
                    }),
                  d || t.attr({ stroke: s.borderColor || n.color || m.color || '#666666' }),
                  this.updatePosition({
                    plotX: g,
                    plotY: u,
                    negative: n.negative,
        ...
        renderSplit(t, e) {
          let i = this,
            {
              ...
              distance: p,
              options: g,
              options: { fixed: u, position: f, positioner: m },
              pointer: x,
            } = i,
            ...
            v =
              i.outside && 'number' != typeof d
                ? oc.documentElement.getBoundingClientRect()
                : { left: y, right: y + o, top: b, bottom: b + r },
            k = i.getLabel(),
            ...
            O = function (t, e, s, o = [0, 0], r = !0) {
              let a, n
              if (s.isHeader)
                (n = M ? 0 : L), (a = of(o[0] - t / 2, v.left, v.right - t - (i.outside ? S : 0)))
              else if (u && s) {
                let o = i.getFixedPosition(t, e, s)
                ;(a = o.x), (n = o.y - A)
              } else
                (n = o[1] - A), (a = of((a = r ? o[0] - t - p : o[0] + p), r ? a : v.left, v.right))
              return { x: a, y: n }
            }
          oS(t) && (t = [!1, t])
          let E = t.slice(0, e.length + 1).reduce(function (t, s, o) {
            if (!1 !== s && '' !== s) {
              let r = e[o - 1] || { isHeader: !0, plotX: e[0].plotX, plotY: a, series: {} },
                l = r.isHeader,
                d = l ? i : r.series,
                f = (d.tt = (function (t, e, s) {
                  ...
                  if (!o) {
                    let t = { padding: n.padding, r: n.borderRadius }
                    c ||
                      ((t.fill = n.backgroundColor),
                      ...
                      (o = w
                        .label(
                          ...
                          0,
                          0,
                          n[r ? 'headerShape' : 'shape'] || (u && !r ? 'rect' : 'callout'),
                          void 0,
                          void 0,
                          n.useHTML
                        )
                  ...
                  return (
                    ...
                    c ||
                      o
                        .css(n.style)
                        .attr({ stroke: n.borderColor || e.color || a.color || '#333333' }),
                    o
                  )
                })(d.tt, r, s.toString())),
                x = f.getBBox(),
                y = x.width + f.strokeWidth()
              l && ((P = x.height), (L += P), M && (A -= P))
              let { anchorX: b, anchorY: S } = (function (t) {
                ...
                if (s) (e = Math.max(n + o, n)), (i = h + a / 2)
                  ...
                  ;(e = t.pos + of(o, -p, t.len + p)),
                    l.shouldShowTooltip(0, s.pos - h + r, { ignoreX: !0 }) && (i = s.pos + r)
                }
                return { anchorX: (e = of(e, v.left - p, v.right + p)), anchorY: i }
              })(r)
              if ('number' == typeof S) {
                let e = x.height + 1,
          ...
          !C &&
            ...
            (E = E.map((t) => {
              ...
              return oy(t, { target: i, x: e })
            })),
            i.cleanSplit(),
            og(E, L)
          let I = { left: S, right: S }
          E.forEach(function (t) {
            let { x: e, boxWidth: s, isHeader: o } = t
            !o &&
              (i.outside && S + e < I.left && (I.left = S + e),
            ...
            E.forEach(function (t) {
              ...
              if (i.outside && e < s) {
                ...
                t > 0 &&
                  ...
                  a && ((n.x = (I.right - I.left) / 2), (n.anchorX = s + t)))
              }
              t.tt.attr(n)
            })
          ...
          if (B && D && N) {
            ...
            N.setSize(t + i, e + s, !1), (D.style.left = I.left + 'px'), (D.style.top = T + 'px')
          }
          op && k.attr({ opacity: 1 === k.opacity ? 0.999 : 1 })
        }
        drawTracker() {
        ...
        headerFooterFormatter(t, e) {
          ...
          return (
            ob(this, 'headerFormatter', a, function (e) {
              if (
                (r && !n && ow(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                r && n)
              ) {
                if (oM(n)) {
                  let t = n
                  ;(od[0] = (e) => i.chart.time.dateFormat(t, e)), (n = '%0')
                }
                ;(t.tooltipDateKeys || ['key']).forEach((t) => {
                  h = h.replace(RegExp('point\\.' + t + '([ \\)}])'), `(point.${t}:${n})$1`)
                })
              }
              i.chart.styledMode && (h = this.styledModeFormat(h)), (e.text = oh(h, t, this.chart))
            }),
            a.text || ''
          )
        }
        update(t) {
          this.destroy(), this.init(this.chart, oT(!0, this.options, t))
        }
        updatePosition(t) {
          let { chart: e, container: i, distance: s, options: o, pointer: r, renderer: a } = this,
            ...
            { left: c, top: p, scaleX: g, scaleY: u } = r.getChartPosition(),
            f = (d || (l && this.getFixedPosition) || this.getPosition).call(this, h, n, t),
            m = w.doc,
          ...
          if (a && i) {
            ...
            ;(b = (o.borderWidth || 0) + 2 * s + 2),
              ...
              (1 !== g || 1 !== u) &&
                (om(i, { transform: `scale(${g}, ${u})` }), (x *= g), (y *= u)),
              (x += c - f.x),
              (y += p - f.y)
          }
      ...
      class oq {
          ...
          i.singular.forEach(function (i) {
            ...
            i.plural.forEach(function (e) {
              t[e].forEach(function (e) {
                e.element &&
                  e.animate(
                    oW({ x: t.startXPos }, e.startYPos ? { x: e.startXPos, y: e.startYPos } : {})
                  )
              })
            })
        }
        applyOptions(t, e) {
          ...
          return (
            oW(this, (t = oq.prototype.optionsToObject.call(this, t))),
            ...
            void 0 === this.x && i
              ...
              : oj(t.x) && i.options.relativeXValue
                ? (this.x = i.autoIncrement(t.x))
                : 'string' == typeof this.x &&
                  (e ?? (e = i.chart.time.parse(this.x)), oj(e) && (this.x = e)),
            ...
            let t = this,
              ...
              a = () => {
                for (let e in ((t.graphic || t.graphics || t.dataLabel || t.dataLabels) &&
                  (oZ(t), t.destroyElements()),
                t))
                  delete t[e]
              }
            t.legendItem && i.legend.destroyItem(t),
              o && (t.setState(), oR(o, t), o.length || (i.hoverPoints = null)),
              t === i.hoverPoint && t.onMouseOut(),
              s?.enabled ? (this.animateBeforeDestroy(), oV(a, r.duration)) : a(),
              i.pointCount--
          }
          this.destroyed = !0
        }
        ...
        optionsToObject(t) {
          ...
          if (oj(t) || null === t) r[s[0]] = t
            ...
            for (
              ...
              (i && void 0 === t[n]) ||
                (s[h].indexOf('.') > 0
                  ? oq.prototype.setNestedProperty(r, t[n], s[h])
                  : (r[s[h]] = t[n])),
                n++,
                h++
          else
        ...
        setNestedProperty(t, e, i) {
          return (
            i.split('.').reduce(function (t, i, s, o) {
              let r = o.length - 1 === s
              return (t[i] = r ? e : oY(t[i], !0) ? t[i] : {}), t[i]
            }, t),
            t
          )
        }
        ...
        update(t, e, i, s) {
          ...
          ;(e = o$(e, !0)), !1 === s ? d() : r.firePointEvent('update', { options: t }, d)
        }
        remove(t, e) {
        ...
        manageEvent(t) {
          let e = oU(this.series.options.point, this.options),
            i = e.events?.[t]
          oG(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map((t) => t.fn).indexOf(i) === -1)
        ...
        setState(t, e) {
          let i = this.series,
            ...
            r = oD.plotOptions[i.type].marker && i.options.marker,
            a = r && !1 === r.enabled,
            n = r?.states?.[t || 'normal'] || {},
            h = !1 === n.enabled,
            l = this.marker || {},
          ...
          if (
            ...
            if (
              ...
              ;(u = i.pointAttribs(this, t)), (f = o$(d.options.chart.animation, o.animation))
              let e = u.opacity
                ...
                (m
                  ...
                  : x &&
                    ((i.stateMarkerGraphic = m =
                      d.renderer
                        .symbol(x, g.x, g.y, g.width, g.height, oU(r, n))
                        .add(i.markerGroup)),
                    (m.currentSymbol = x))),
            ...
            ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
              ...
              p.attr({
                class:
                  ...
                  o$(this.colorIndex, i.colorIndex) +
              ...
              d.styledMode ||
                p.attr(
                  oW(
                    ...
                    t6.filterUserAttributes(y.attributes || {})
                  )
                ))
            : p?.point?.haloPath &&
              !p.point.destroyed &&
              p.animate({ d: p.point.haloPath(0) }, null, p.hide),
            oH(this, 'afterSetState', { state: t })
        }
        haloPath(t) {
          let e = this.pos()
          return e
            ? this.series.chart.renderer.symbols.circle(oz(e[0], 1) - t, e[1] - t, 2 * t, 2 * t)
            : []
        }
      }
      let oK = oq,
      ...
      class rr {
        ...
        destroy() {
          ...
          this.eventsToUnbind.forEach((t) => t()),
            (this.eventsToUnbind = []),
            !w.chartCount &&
              (rr.unbindDocumentMouseUp.forEach((t) => t.unbind()),
              (rr.unbindDocumentMouseUp.length = 0),
              rr.unbindDocumentTouchEnd &&
                (rr.unbindDocumentTouchEnd = rr.unbindDocumentTouchEnd())),
        ...
        getSelectionMarkerAttrs(t, e) {
          ...
          return (
            o4(this, 'getSelectionMarkerAttrs', i, (i) => {
              let s,
              ...
              ;(l.x = o.plotLeft),
                ...
                a && ((l.height = Math.max(1, Math.abs((s = e - h)))), (l.y = (s > 0 ? 0 : s) + h))
            }),
            i
          )
        }
        drag(t) {
          ...
          if (
            ...
            this.hasZoom &&
              ...
              e.styledMode || m.attr({ fill: a || oJ('#334eff').setOpacity(0.25).get() })),
              m && m.attr(l),
              f && !m && c && e.pan(t, o)
          }
        }
        ...
        getSelectionBox(t) {
          ...
          return o4(this, 'getSelectionBox', e), e.result
        }
        drop(t) {
          let e,
          ...
          i &&
            o8(i.index) &&
            (o5(i.container, { cursor: i._cursor }),
                ...
                (!o7(s, !0) ||
                  (function (t, i) {
                    let s,
                      o = t.distX - i.distX,
                      r = t.dist - i.dist,
                      a = i.series.group?.zIndex - t.series.group?.zIndex
                    return 0 !== o && e
                      ? o
                      : 0 !== r
                        ? r
        ...
        getChartCoordinatesFromPoint(t, e) {
          ...
          if (i && s) {
            let r = t.clientX ?? t.plotX ?? 0,
              a = t.plotY || 0
            return (
              t.isNode && o && o8(o.x) && o8(o.y) && ((r = o.x), (a = o.y)),
              e
                ? { chartX: s.len + s.pos - a, chartY: i.len + i.pos - r }
                : { chartX: r + i.pos, chartY: a + s.pos }
            )
          }
          if (o?.x && o.y) return { chartX: o.x, chartY: o.y }
        }
        getChartPosition() {
            ...
            c &&
              (o && !h.noSharedTooltip
                ? (l = i.filter(function (t) {
                    ...
                    o7(i) && (t.boosted && t.boost && (i = t.boost.getPoint(i)), a.push(i))
                  })
                : a.push(c)),
            o4(this, 'afterGetHoverData', (d = { hoverPoint: c })),
        ...
        normalize(t, e) {
          ...
          let o = s.pageX - e.left,
            r = s.pageY - e.top
          return o6(t, { chartX: Math.round((o /= e.scaleX)), chartY: Math.round((r /= e.scaleY)) })
        }
        onContainerClick(t) {
          let e = this.chart,
            i = e.hoverPoint,
          ...
          !e.cancelClick &&
            (i && this.inClass(s.target, 'highcharts-tracker')
              ? (o4(i.series, 'click', o6(s, { point: i })),
                e.hoverPoint && i.firePointEvent('click', s))
              : (o6(s, this.getCoordinates(s)),
        ...
        onDocumentMouseMove(t) {
          ...
          !s ||
            e.isInsidePlot(o.chartX - e.plotLeft, o.chartY - e.plotTop, { visiblePlotOnly: !0 }) ||
          ...
          a > 1 ? (e.initiated = !0) : l && (e.initiated = !1),
            ...
            'touchstart' === t.type
              ...
              : l
                ...
                : o &&
                  (o4(i, 'touchpan', { originalEvent: t, touches: r }, () => {
                    let e = (t) => {
                      let e = t[0],
                        i = t[1] || e
                      return {
        ...
        runPointActions(t, e, i) {
          ...
          this.unDocMouseMove ||
            ((this.unDocMouseMove = o2(s.container.ownerDocument, 'mousemove', (t) =>
              oQ[rr.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)
            )),
        ...
        setDOMEvents() {
          ...
          ;(t.onmousedown = this.onContainerMouseDown.bind(this)),
            ...
            this.eventsToUnbind.push(
              o2(t, 'mouseenter', this.onContainerMouseEnter.bind(this)),
              o2(t, 'mouseleave', this.onContainerMouseLeave.bind(this))
            ),
            rr.unbindDocumentMouseUp.some((t) => t.doc === e) ||
              rr.unbindDocumentMouseUp.push({
                doc: e,
          ...
          for (; i && 'BODY' !== i.tagName; )
            this.eventsToUnbind.push(
              ...
              (i = i.parentElement)
          this.eventsToUnbind.push(
            o2(t, 'touchstart', this.onContainerTouchStart.bind(this), { passive: !1 }),
            o2(t, 'touchmove', this.onContainerTouchMove.bind(this), { passive: !1 })
          ),
            rr.unbindDocumentTouchEnd ||
              (rr.unbindDocumentTouchEnd = o2(e, 'touchend', this.onDocumentTouchEnd.bind(this), {
                passive: !1,
              })),
        ...
        setPointerCapture() {
          ...
          let t = this.pointerCaptureEventsToUnbind,
            ...
            i = e.container,
            s =
              ri(e.options.tooltip?.followTouchMove, !0) &&
          ...
          !this.hasPointerCapture && s
            ? (t.push(
              ...
              e.styledMode || o5(i, { 'touch-action': 'none' }),
      ...
      !(function (t) {
        ;(t.setLength = function (t, e, i) {
          ...
          (t.splice = function (t, e, i, s, o = []) {
            if (Array.isArray(t))
              return (
                Array.isArray(o) || (o = Array.from(o)), { removed: t.splice(e, i, ...o), array: t }
              )
        ...
        rp = class {
          ...
          deleteRows(t, e = 1) {
            if (e > 0 && t < this.rowCount) {
              let i = 0
              rd(this.columns, (s, o) => {
                ;(this.columns[o] = rh(s, t, e).array), (i = s.length)
              }),
                (this.rowCount = i)
            }
            rl(this, 'afterDeleteRows', { rowIndex: t, rowCount: e }), (this.versionTag = rc())
          }
          getColumn(t, e) {
          ...
          setColumns(t, e, i) {
            ...
            rd(t, (t, e) => {
              ...
              i?.silent || (rl(this, 'afterSetColumns'), (this.versionTag = rc()))
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            rd(t, (t, a) => {
              ...
              n && (i ? (n = rh(n, e, 0, !0, [t]).array) : (n[e] = t), (o[a] = n))
            }),
              r > this.rowCount && this.applyRowCount(r),
              s?.silent || (rl(this, 'afterSetRows'), (this.versionTag = rc()))
          }
        },
      ...
      !(function (t) {
        function e(t, e, i) {
          ...
          if (
            ...
            s.line.attr({ d: t }), s.area?.attr({ d: [...t, ['L', n - x, a], ['L', x, a]] })
          }
          if (m && !1 !== m.enabled && n) {
            let t = Math.min(rf(m.radius, d), d)
            0 === l.indexOf('url') && ((m = ru(m, { width: h, height: h })), (t = 0)),
              (s.symbol = f =
                c
                  .symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, rg({ context: 'legend' }, m))
      ...
      class r0 {
        ...
        init(t, e) {
          let i
          rG(this, 'init', { options: e }), this.dataTable ?? (this.dataTable = new rp())
          let s = t.series
          ...
          ;(this.linkedSeries = []),
            this.bindAxes(),
            rX(this, { name: o.name, state: '', visible: r, selected: !0 === o.selected }),
            rT(this, o)
          let a = o.events
          ...
          rG(this, 'bindAxes', null, function () {
            ;(e.axisTypes || []).forEach(function (o) {
              ;(s[o] || []).forEach(function (s) {
                ;(t = s.options),
                  (rK(i[o], 0) === s.index || (void 0 !== i[o] && i[o] === t.id)) &&
                    (rU(e, s.series), (e[o] = s), (s.isDirty = !0))
              }),
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e = rK(this.pointInterval, i.pointInterval, 1)),
            o && rV(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a)
          ...
          return o && rV(t) ? a + e : ((this.xIncrement = a + e), a)
        }
        setDataSortingOptions() {
          let t = this.options
          rX(this, { requireSorting: !1, sorted: !1, enabledDataSorting: !0, allowDG: !1 }),
        ...
        setOptions(t) {
          ...
          ;(this.tooltipOptions = r_(
            rS.tooltip,
            rS.plotOptions.series?.tooltip,
            c?.tooltip,
            ...
            (this.stickyTracking = rK(
              r.stickyTracking,
              p.stickyTracking,
              d.stickyTracking,
              (!!this.tooltipOptions.shared && !this.noSharedTooltip) || g.stickyTracking
            )),
          ...
          return (
            (g.negativeColor || g.negativeFillColor) &&
              ...
              a || ((e.color = g.negativeColor), (e.fillColor = g.negativeFillColor)),
              u.push(e)),
            u.length &&
              rN(u[u.length - 1].value) &&
              u.push(a ? {} : { color: this.color, fillColor: this.fillColor }),
            rG(this, 'afterSetOptions', { options: g }),
            g
          )
        }
        getName() {
        ...
        getCyclic(t, e, i) {
          ...
          !e &&
            (rN((o = rK('color' === t ? this.options.colorIndex : void 0, this[a])))
              ? (s = o)
        ...
        getColor() {
          this.chart.styledMode
            ...
            : this.options.colorByPoint
              ...
              : this.getCyclic(
                  'color',
                  this.options.color || rS.plotOptions[this.type].color,
        ...
        updateData(t, e) {
          let { options: i, requireSorting: s } = this,
            o = i.dataSorting,
            r = this.points,
            a = [],
            n = t.length === r.length,
          ...
          if (
            ...
            t.forEach((t, e) => {
              let l,
                d =
                  (rN(t) && this.pointClass.prototype.optionsToObject.call({ series: this }, t)) ||
                  {},
                { id: p, x: g } = d
              p || rV(g)
                ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l
                    ? a.push(t)
                    : r[l] && t !== i.data?.[l]
                      ? (r[l].update(t, !1, void 0, !1), (r[l].touched = !0), s && (c = l + 1))
                      : r[l] && (r[l].touched = !0),
                  (!n || e !== l || o?.enabled || this.hasDerivedData) && (h = !0))
                : a.push(t)
            }, this),
            h)
          )
            for (l = r.length; l--; ) (d = r[l]) && !d.touched && d.remove?.(!1, e)
          else
            n && !o?.enabled
              ? (t.forEach((t, e) => {
          ...
          return (
            null === this.xIncrement &&
              g.length &&
              ((this.xIncrement = rO(g)), this.autoIncrement()),
            !0
          )
        }
        dataColumnKeys() {
        ...
        setData(t, e = !0, i, s) {
          ...
          if (
            ...
            for (
              rZ(this.getColumn('y')[0]) && rH(14, !0, n),
                this.data = [],
        ...
        sortData(t) {
          let e = this,
            ...
            s = function (t, e) {
              return (rN(e) && t.pointClass.prototype.optionsToObject.call({ series: t }, e)) || {}
            }
          return (
              ...
              s &&
                ...
                (m[l - 1] < u || m[0] > f
                  ...
                  : e.getColumn(e.pointValKey || 'y').length &&
                    (m[0] < u || m[l - 1] > f) &&
                    ((x = (d = this.cropData(i, u, f)).modified), (p = d.start), (c = !0)))),
            (m = x.getColumn('x') || []),
            {
              modified: x,
              cropped: c,
              cropStart: p,
              closestPointRange: rj(
                [h ? m.map(h.log2lin) : m],
                () => e.requireSorting && !y && rH(15, !1, e.chart)
              ),
            }
          )
        }
        ...
        cropData(t, e, i) {
          ...
          return { modified: new rp({ columns: r }), start: h, end: l }
        }
        generatePoints() {
          let t = this.options,
          ...
          for (h && n && (this.options.keys = !1), x = 0; x < r; x++)
            (f = a + x),
              n
                ? (((m = new o(this, i.getRow(x, g) || [])).dataGroup = this.groupMap[d + x]),
                  m.dataGroup?.options &&
                    ((m.options = m.dataGroup.options),
                    rX(m, m.dataGroup.options),
                    delete m.dataLabels))
                : ((m = y[f]),
          ...
          if (((this.options.keys = h), y && (r !== (u = y.length) || n)))
            for (x = 0; x < u; x++)
              x !== a || n || (x += r), y[x] && (y[x].destroyElements(), (y[x].plotX = void 0))
          ;(this.data = y), (this.points = l), rG(this, 'afterGeneratePoints')
        }
        getXExtremes(t) {
          return { min: rE(t), max: rO(t) }
        }
        getExtremes(t, e) {
          let { xAxis: i, yAxis: s } = this,
            ...
            x = 0,
            y = 0
          for (i && ((x = (u = i.getExtremes()).min), (y = u.max)), m = 0; m < a; m++)
            if (((f = l[m]), g || ((l[m + c] || f) >= x && (l[m - c] || f) <= y)))
              for (let t of h) {
                let e = t[m]
                rV(e) && (e > 0 || !p) && d.push(e)
              }
          let b = { activeYData: d, dataMin: rE(d), dataMax: rO(d) }
          return rG(this, 'afterGetExtremes', { dataExtremes: b }), b
        }
        applyExtremes() {
        ...
        translate() {
          ...
          for (p = 0; p < a; p++) {
            let t,
              ...
              M =
                e &&
                o.stacking?.stacks[(this.negStacks && k < (d ? 0 : l) ? '-' : '') + this.stackKey]
            ;(a.plotX = rV((g = i.translate(y, !1, !1, !1, !0, n))) ? rD(x(g)) : void 0),
              ...
              rV(k) && void 0 !== a.plotX
                ? (t = rV((t = o.translate(k, !1, !0, !1, !0))) ? x(t) : void 0)
                : !rV(k) && c && (t = c),
              (a.plotY = t),
              ...
              a.isNull ||
                !1 === a.visible ||
                (void 0 !== u && (m = Math.min(m, Math.abs(g - u))), (u = g)),
              (a.zone = this.zones.length ? a.getZone() : void 0),
              !a.graphic && this.group && s && (a.isNew = !0)
          }
          ;(this.closestPointRangePx = m), rG(this, 'afterTranslate')
        }
              ...
              if (((m && !rN(r.enabled)) || r.enabled) && (!c || g) && !1 !== i.visible) {
                ...
                if (
                  (!s &&
                    ...
                    ((i.graphic = s =
                      h.renderer.symbol(t, n.x, n.y, n.width, n.height, a ? r : p).add(u)),
        ...
        markerAttribs(t, e) {
          ...
          return (
            rV(l) &&
              d &&
              (i.crisp && (d[0] = rB(d[0], t.hasImage ? 0 : 'rect' === r ? s?.lineWidth || 0 : 1)),
              (a.x = d[0] - l),
              (a.y = d[1] - l)),
        ...
        pointAttribs(t, e) {
          ...
          return (
            ...
            (u = rK(
              ...
              l.lineWidth,
              u + rK(d.lineWidthPlus, l.lineWidthPlus, 0)
            )),
            (p = d.fillColor || l.fillColor || p),
            (g = d.lineColor || l.lineColor || g),
            { stroke: g, 'stroke-width': u, fill: p, opacity: (f = rK(d.opacity, l.opacity, f)) }
          )
        }
        destroy(t) {
          let e,
            ...
            s = this,
            o = s.chart,
            r = /AppleWebKit\/533/.test(rA.navigator.userAgent),
            a = s.data || []
          for (
            rG(s, 'destroy', { keepEventsForUpdate: t }),
              this.removeEvents(t),
              (s.axisTypes || []).forEach(function (t) {
                ;(i = s[t]), i?.series && (rW(i.series, s), (i.isDirty = i.forceRedraw = !0))
              }),
            ...
            a[e]?.destroy?.()
          for (let t of s.zones) rz(t, void 0, !0)
        ...
        applyZones() {
          ...
          if (s.length && (i || t) && d && rV(d.min)) {
            ...
            if (
              (s.forEach((t) => {
                ;(t.lineClip = []), (t.translated = rI(d.toPixels(rK(t.value, e), !0) || 0, 0, p))
              }),
          ...
          return (
            ...
            r.addClass(
              'highcharts-' +
                ...
                this.type +
                '-series ' +
                (rN(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
        ...
        drawTracker() {
          let t = this,
            ...
            l = 'rgba(192,192,192,' + (rC ? 1e-4 : 0.002) + ')',
            d = t.tracker
          d
            ? d.attr({ d: s })
            : t.graph &&
              ((t.tracker = d =
                a
                  .path(s)
                  .attr({ visibility: t.visible ? 'inherit' : 'hidden', zIndex: 2 })
        ...
        addPoint(t, e, i, s, o) {
          ...
          d.setRow(f, a, !0, { addColumns: !1 }),
            p && f.name && (p[m] = f.name),
            g?.splice(a, 0, t),
            (r || this.processedData) && (this.data.splice(a, 0, null), this.processData()),
            'point' === n.legendType && this.generatePoints(),
            i &&
              (l[0] && l[0].remove
                ? l[0].remove(!1)
                : ([l, g].filter(rN).forEach((t) => {
                    t.shift()
                  }),
                  d.deleteRows(0))),
            !1 !== o && rG(this, 'addPoint', { point: f }),
            (this.isDirty = !0),
            (this.isDirtyData = !0),
            e && h.redraw(s)
        }
        removePoint(t, e, i) {
          ...
          rM(i, o), (e = rK(e, !0)), h ? h.firePointEvent('remove', null, l) : l()
        }
        remove(t, e, i, s) {
          let o = this,
            r = o.chart
        ...
        update(t, e) {
          rG(this, 'update', { options: (t = rR(t, this.userOptions)) })
          let i = this,
            s = i.chart,
            o = i.userOptions,
          ...
          ;(g = g || r),
            u
              ? (p.push.apply(p, r0.keepPropsForPoints),
                !1 !== t.visible && p.push('area', 'graph'),
                i.parallelArrays.forEach(function (t) {
                  p.push(t + 'Data')
                }),
                t.data &&
                  (t.dataSorting && rX(i.options.dataSorting, t.dataSorting),
            ...
            (p = ['group', 'markerGroup', 'dataLabelsGroup', 'transformGroup'].concat(p)).forEach(
              function (t) {
                ;(p[t] = i[t]), delete i[t]
              }
            )
          ...
          } else rH(17, !0, s, { missingModuleFor: g })
          if (
        ...
        setState(t, e) {
          ...
          if (
            ...
            if (
              (t &&
                ((h = a[t].lineWidth || h + (a[t].lineWidthPlus || 0)), (l = rK(a[t].opacity, l))),
              o && !o.dashstyle && rV(h))
            )
      ...
      class ag {
        ...
        update(t, e) {
          ...
          this.setOptions(an(!0, this.options, t)),
            ...
            ah(e, !0) && i.redraw(),
            ar(this, 'afterUpdate', { redraw: e })
        }
        colorizeItem(t, e) {
          let i = t.color,
            { area: s, group: o, label: r, line: a, symbol: n } = t.legendItem || {}
          if (
            ((t instanceof r1 || t instanceof oK) && (t.color = t.options?.legendSymbolColor || i),
            ...
            r?.css(an(e ? this.itemStyle : i)),
              ...
              n && n.attr(p(c && n.isMarker ? t.pointAttribs() : { fill: t.color })),
              s?.attr(p({ fill: h || t.color, 'fill-opacity': h ? 1 : (l ?? 0.75) }))
          }
          ;(t.color = i), ar(this, 'afterColorizeItem', { item: t, visible: e })
        }
        positionItems() {
        ...
        positionItem(t) {
          let { group: e, x: i = 0, y: s = 0 } = t.legendItem || {},
            ...
            n = t.checkbox
          if (e?.element) {
            let o = { translateX: a ? i : this.legendWidth - i - 2 * r - 4, translateY: s }
            e[ai(e.translateY) ? 'animate' : 'attr'](o, void 0, () => {
              ar(this, 'afterPositionItem', { item: t })
            })
          }
          n && ((n.x = i), (n.y = s))
        }
        ...
        renderItem(t) {
          ...
          !y &&
            ...
            !this.baseline &&
              ...
              o.squareSymbol &&
                ((this.symbolWidth = ah(o.symbolWidth, Math.max(this.symbolHeight, 16))),
            ...
            (i.styledMode || !h.width) &&
              y.css({ width: (o.itemWidth || this.widthOption || i.spacingBox.width) - b + 'px' }),
            this.setText(t)
          let v = y.getBBox(),
        ...
        getAllItems() {
          ...
          return (
            this.chart.series.forEach(function (e) {
              let i = e?.options
              e &&
                ah(i.showInLegend, !ai(i.linkedTo) && void 0, !0) &&
                (t = t.concat(e.legendItem?.labels || ('point' === i.legendType ? e.data : e)))
            }),
            ar(this, 'afterGetAllItems', { allItems: t }),
            t
          )
        }
        getAlignment() {
        ...
        proximatePositions() {
          ...
          for (let o of (this.allItems.forEach(function (t) {
            ...
            t.yAxis &&
              ...
              t.points &&
                (o = ao(a ? t.points : t.points.slice(0).reverse(), function (t) {
                  return aa(t.plotY)
                })),
              (r =
          ...
          r4(i, e.plotHeight)))
            (t = o.item.legendItem || {}), aa(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos)
        }
        render() {
          let t = this.chart,
            e = t.renderer,
          ...
          ;(this.itemX = s),
            ...
            d ||
              (this.box = d =
                e.rect().addClass('highcharts-legend-box').attr({ r: i.borderRadius }).add(h)),
            t.styledMode ||
              d
                .attr({
            ...
            a > 0 &&
              ...
              d[d.placed ? 'animate' : 'attr'](
                d.crisp.call({}, { x: 0, y: 0, width: a, height: n }, d.strokeWidth())
              ),
            h[r ? 'show' : 'hide'](),
        ...
        handleOverflow(t) {
          ...
          return (
            ...
            t && v > 0 && t > v && !1 !== l.enabled
              ? ((this.clipHeight = m = Math.max(v - 20 - this.titleHeight - n, 0)),
                ...
                w || ((w = e.clipRect = s.clipRect(0, n - 2, 9999, 0)), e.contentGroup.clip(w)),
                u(m),
                k ||
        ...
        scroll(t, e) {
          ...
          l > o && (l = o),
            l > 0 &&
              ...
              i.styledMode ||
                (this.up.attr({ fill: 1 === l ? a.inactiveColor : a.activeColor }),
                this.upTracker.css({ cursor: 1 === l ? 'default' : 'pointer' }),
                this.down.attr({ fill: l === o ? a.inactiveColor : a.activeColor }),
                this.downTracker.css({ cursor: l === o ? 'default' : 'pointer' })),
              ...
              ap(
                () => {
                  ar(this, 'afterScroll', { currentPage: l })
                },
            ...
            i &&
              i
                ...
                .on('click', function (e) {
                  ...
                  r.removeClass(h),
                    ar(s, 'itemClick', { browserEvent: e, legendItem: t }, i),
                    a
                      ? t.firePointEvent('legendItemClick', { browserEvent: e })
                      : n && ar(t, 'legendItemClick', { browserEvent: e })
                })
        }
        createCheckboxForItem(t) {
          ;(t.checkbox = at(
            ...
            r7(t.checkbox, 'click', function (e) {
              let i = e.target
              ar(t.series || t, 'checkboxClick', { checked: i.checked, item: t }, function () {
                t.select()
              })
            })
        }
      ...
      class a0 {
        ...
        constructor(t, e, i) {
          this.sharedClips = {}
          let s = [...arguments]
          ;(aY(t) || t.nodeName) && (this.renderTo = s.shift()), this.init(s[0], s[1])
        }
        setZoomOptions() {
        ...
        init(t, e) {
          aW(this, 'init', { args: arguments }, function () {
            ...
            ;(this.userOptions = az({}, t)),
              ...
              (this.time = new tu(az(i.time || {}, { locale: this.locale }), i.lang)),
        ...
        initSeries(t) {
          let e = this.options.chart,
            i = t.type || e.type,
            s = aC[i]
          s || aN(17, !0, this, { missingModuleFor: i })
          let o = new s()
        ...
        isInsidePlot(t, e, i = {}) {
          ...
          if (!i.ignoreX) {
            let t = (d && (s && !this.polar ? d.yAxis : d.xAxis)) || { pos: r, len: 1 / 0 },
          ...
          return aW(this, 'afterIsInsidePlot', u), u.isInsidePlot
        }
        redraw(t) {
          ...
          i.forEach(function (t) {
            t.isDirty &&
              ('point' === t.options.legendType
                ? ('function' == typeof t.updateTotals && t.updateTotals(), (g = !0))
                : r && (r.labelFormatter || r.labelFormat) && (g = !0)),
              t.isDirtyData && aW(t, 'updatedData')
          }),
            g && o && o.options.enabled && (o.render(), (this.isDirtyLegend = !1)),
            d && this.getStacks(),
            e.forEach(function (t) {
            ...
            e.forEach(function (t) {
              ...
              t.extKey !== e &&
                ((t.extKey = e),
                h.push(function () {
                  aW(t, 'afterSetExtremes', az(t.eventArgs, t.getExtremes())), delete t.eventArgs
                })),
                (p || d) && t.redraw()
            }),
            p && this.drawChartBox(),
        ...
        get(t) {
          ...
          for (let t = 0; !s && t < e.length; t++) s = aR(e[t].points || [], i)
          return s
        }
        createAxes() {
          let t = this.userOptions
          for (let e of (aW(this, 'createAxes'), ['xAxis', 'yAxis']))
            for (let i of (t[e] = aK(t[e] || {}))) new s$(this, i, e)
          ...
          o && e && (this[t] = o = o.destroy()),
            s &&
              ...
              (((o = this.renderer
                ...
                .attr({ align: s.align, class: 'highcharts-' + t, zIndex: s.zIndex || 4 })
        ...
        layOutTitles(t = !0) {
          ...
          ;['title', 'subtitle', 'caption'].forEach((t) => {
            let i = this[t],
              ...
              n = i?.textPxLength || 0
            if (i && r) {
              aW(this, 'layOutTitle', { alignTo: a, key: t, textPxLength: n })
        ...
        getContainerBox() {
          let t = [].map.call(this.renderTo.children, (t) => {
            ...
            e = {
              width: aX(this.renderTo, 'width', !0) || 0,
              height: aX(this.renderTo, 'height', !0) || 0,
            }
          return (
        ...
        temporaryDisplay(t) {
          ...
          if (t)
            for (; e?.style; )
              e.hcOrigStyle && (aO(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached && (aw.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode)
          else
            for (
              ;
              ...
              (aw.body.contains(e) ||
                e.parentNode ||
                ((e.hcOrigDetached = !0), aw.body.appendChild(e)),
              ('none' === aX(e, 'display', !1) || e.hcOricDetached) &&
                ((e.hcOrigStyle = {
        ...
        getContainer() {
          ...
          let l = aL('div', { id: o }, t, r)
          ;(this.container = l),
            this.getChartSize(),
            h !== this.chartWidth &&
              ((h = this.chartWidth),
              this.styledMode || aO(l, { width: aV(i.style?.width, h + 'px') })),
          ...
          delete e.pointer?.chartPosition,
            !e.exporting?.isPrinting &&
              ...
              ((s.width !== i.width || s.height !== i.height) &&
                (V.clearTimeout(e.reflowTimeout),
        ...
        setSize(t, e, i) {
          ...
          ;(s.isDirtyBox || a !== s.oldChartWidth || n !== s.oldChartHeight) &&
            (s.styledMode ||
              (r ? af : aO)(s.container, { width: `${a + h}px`, height: `${n + l}px` }, r),
            s.setChartSize(!0),
            o.setSize(a, n, r),
        ...
        setChartSize(t) {
          let e,
            ...
            s,
            o,
            { chartHeight: r, chartWidth: a, inverted: n, spacing: h, renderer: l } = this,
            d = this.clipOffset,
          ...
          ;(this.plotLeft = e = Math.round(this.plotLeft)),
            ...
            (this.spacingBox = l.spacingBox =
              { x: h[3], y: h[0], width: a - h[3] - h[1], height: r - h[0] - h[2] }),
            ...
            t ||
              ...
              l.alignElements()),
            aW(this, 'afterSetChartSize', { skipAxes: t })
        }
        resetMargins() {
        ...
        drawChartBox() {
          ...
          m ||
            ...
            o
              ? (b = v = m.strokeWidth())
              : ((v = (b = t.borderWidth || 0) + 8 * !!t.shadow),
                (k = { fill: a || 'none' }),
                (b || m['stroke-width']) && ((k.stroke = t.borderColor), (k['stroke-width'] = b)),
            ...
            u ? u.animate({ width: f.width, height: f.height }) : (this.clipRect = e.clipRect(f)),
            (w = 'animate'),
            y ||
              ((w = 'attr'),
              (this.plotBorder = y =
        ...
        propFromSeries() {
          ...
          ;['inverted', 'angular', 'polar'].forEach(function (a) {
            for (e = aC[o.type], i = o[a] || (e && e.prototype[a]), t = r?.length; !i && t--; )
        ...
        linkSeries(t) {
          ...
          i.forEach(function (t) {
            ...
            aW(this, 'afterLinkSeries', { isUpdating: t })
        }
        renderSeries() {
          this.series.forEach(function (t) {
        ...
        render() {
          ...
          t)) {
            ...
            if (
              ...
              if (
                (s.destroy(),
                o &&
                  aV(i.reserveSpace, !aG(t.crossing)) &&
                  (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
                r)
              ) {
                o?.destroy()
                break
          ...
          this.drawChartBox(),
            ...
            this.dataLabelsGroup ||
              (this.dataLabelsGroup = i.g('datalabels-group').attr({ zIndex: 6 }).add()),
            this.renderSeries(),
            this.addCredits(),
        ...
        destroy() {
          ...
          ;[
            ...
            o && ((o.innerHTML = t6.emptyHTML), aq(o), r && aD(o)),
            a$(e, function (t, i) {
              delete e[i]
            })
        }
        ...
        addSeries(t, e, i) {
          ...
          return (
            t &&
              ((e = aV(e, !0)),
              aW(o, 'addSeries', { options: t }, function () {
                ;(s = o.initSeries(t)),
                  (o.isDirtyLegend = !0),
                  o.linkSeries(),
                  s.enabledDataSorting && s.setData(t.data, !1),
                  aW(o, 'afterAddSeries', { series: s }),
                  e && o.redraw(i)
              })),
            s
          )
        ...
        createAxis(t, e) {
          ...
          return aV(e.redraw, !0) && this.redraw(e.animation), i
        }
        showLoading(t) {
          let e = this,
            i = e.options,
          ...
          r ||
            ...
            a ||
              ((e.loadingSpan = a = aL('span', { className: 'highcharts-loading-inner' }, null, r)),
              aA(e, 'redraw', o)),
            (r.className = 'highcharts-loading'),
            t6.setElementHTML(a, aV(t, i.lang.loading, '')),
            !e.styledMode &&
              (aO(r, az(s.style, { zIndex: 10 })),
              aO(a, s.labelStyle),
              e.loadingShown ||
                (aO(r, { opacity: 0, display: '' }),
                af(r, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))),
            (e.loadingShown = !0),
            o()
        }
        hideLoading() {
        ...
        update(t, e, i, s) {
                ...
                (aK(t[e]).forEach(function (t, s) {
                  ...
                  r && (o = n.get(t.id)),
                    !o &&
                      n[e] &&
                      (o = n[e][aV(t.index, s)]) &&
                      ((r && aE(o.options.id)) || o.options.isInternal) &&
                      (o = void 0),
          ...
          a || (aG(p) && p !== n.chartWidth) || (aG(g) && g !== n.chartHeight)
            ? n.setSize(p, g, s)
            : aV(e, !0) && n.redraw(s),
            aW(n, 'afterUpdate', { options: t, redraw: e, animation: s })
        }
        setSubtitle(t, e) {
        ...
        zoomOut() {
          aW(this, 'selection', { resetSelection: !0 }, () =>
        ...
        transform(t) {
          ...
          for (let t of e) {
            ...
            let T = t.chart.polar || t.isOrdinal ? 0 : u * S || 0,
              ...
              O = t.allExtremes
            if (
              (r && r[t.coll].push({ axis: t, min: Math.min(C, A), max: Math.max(C, A) }),
              P > L && ([P, L] = [L, P]),
              1 === k && !o && 'yAxis' === t.coll && !O)
            ) {
              for (let e of t.series) {
                let t = e.getExtremes(e.getProcessedData(!0).modified.getColumn('y') || [], !0)
                O ?? (O = { dataMin: Number.MAX_VALUE, dataMax: -Number.MAX_VALUE }),
                  aG(t.dataMin) &&
                    aG(t.dataMax) &&
                    ((O.dataMin = Math.min(t.dataMin, O.dataMin)),
                    (O.dataMax = Math.max(t.dataMax, O.dataMax)))
              }
              t.allExtremes = O
            }
            let { dataMin: E, dataMax: I, min: D, max: B } = az(t.getExtremes(), O || {}),
              N = l.parse(f.min),
              z = l.parse(f.max),
              R = E ?? N,
              W = I ?? z,
            ...
            ;(!t.isOrdinal || 1 !== k || o) &&
              (P < Y && ((P = Y), k >= 1 && (L = P + H)),
              L > U && ((L = U), k >= 1 && (P = L - H)),
              (o || (t.series.length && (P !== D || L !== B) && P >= Y && L <= U)) &&
                (r
                  ? r[t.coll].push({ axis: t, min: P, max: L })
                  : ((t.isPanning = 'zoom' !== n),
                    t.isPanning && (p = !0),
                    t.setExtremes(o ? void 0 : P, o ? void 0 : L, !1, !1, {
                      move: M,
                      trigger: n,
                      scale: k,
                    }),
                    !o && (P > Y || L < U) && 'mousewheel' !== n && (c = !0)),
                (d = !0)),
              this.hasCartesianSeries || o || 'mousewheel' === n || (c = !0),
      ...
      function nt() {
        ...
        ;(this.scrollablePixelsX || this.scrollablePixelsY) &&
          !t &&
          (this.scrollablePlotArea = t = new ni(this)),
          t?.applyFixed()
      }
      function ne() {
      ...
      class ni {
            ...
            if (
              (r
                ? ((t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth)),
                  i &&
                    ((t.scrollablePlotBox = a8(t.plotBox)),
        ...
        constructor(t) {
          ...
          t.scrollablePixelsX && (a.overflowX = 'auto'),
            ...
            (this.chart = t)
          let n = (this.parentDiv = a5(
              'div',
              { className: 'highcharts-scrolling-parent' },
              { position: 'relative' },
              t.renderTo
            )),
            h = (this.scrollingContainer = a5('div', { className: 'highcharts-scrolling' }, a, n)),
            l = (this.innerContainer = a5(
              'div',
          ...
          ;(this.mask = c
            ...
            a6(t.renderTo, { overflow: 'visible' }),
        ...
        applyFixed() {
          ...
          e.setSize(r, a),
            ...
            a1(t.container),
            a6(n, { width: `${m}px`, height: `${x}px` }),
            t.renderer.boxWrapper.attr({ width: m, height: x, viewBox: [0, 0, m, x].join(' ') }),
            t.chartBackground?.attr({ width: m, height: x }),
            a6(s, { width: `${r}px`, height: `${a}px` }),
            a9(i) || ((s.scrollLeft = p * u), (s.scrollTop = g * f))
          let y = d - o[0] - 1,
            b = l - o[3] - 1,
            v = d + h + o[2] + 1,
            k = l + c + o[1] + 1,
      ...
      let { format: ns } = ep,
        ...
        nd = class {
          ...
          render(t) {
            ...
            ;(this.label.labelrank = e.plotSizeY), na(this, 'afterRender')
          }
          setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
              let t = h.getBBox(void 0, 0),
                e = h.padding,
                i = 'justify' === nl(l.overflow, 'justify'),
                s
              ;(a.x = l.x || 0), (a.y = l.y || 0)
            ...
            na(this, 'afterSetOffset', { xOffset: t, width: e })
          }
          ...
          getStackBox(t) {
            let e = this.axis,
              ...
              p = Math.abs(
                l -
                  e.toPixels(n || (nh(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min)) || 0)
              ),
              g = i.inverted,
              u = this.isNegative
            return g
      ...
      function nC(t, e, i) {
        ...
        ;(t[0] = nu(t[0] * s)), (t[1] = nu(t[1] * s)), (this.stackedYData[i] = t[1])
      }
      function nA(t) {
        ;(this.is('column') || this.is('columnrange')) &&
          (this.options.centerInCategory && this.chart.series.length > 1
            ? np.setStackedPoints.call(this, t, 'group')
        ...
        for (k.stacksTouched += 1, h = 0; h < g; h++) {
          ...
          ;(n = (i = this.getStackIndicator(i, e, this.index)).key || ''),
            ...
            w[a][e] ||
              (M[a]?.[e]
                ...
                : (w[a][e] = new nd(t, t.options.stackLabels, !!s, e, x))),
            (o = w[a][e]),
            null !== g
              ? ((o.points[n] = o.points[this.index] = [nv(o.cumulative, m)]),
          ...
          'percent' === l
            ? ((r = s ? y : b),
              (S =
                v && w[r]?.[e]
                  ? ((r = w[r][e]).total = Math.max(r.total || 0, S) + Math.abs(u))
                  : nu(S + Math.abs(u))))
            : 'group' === l
              ? ny(g) && S++
              : (S = nu(S + u)),
            'group' === l
              ? (o.cumulative = (S || 1) - 1)
              : (o.cumulative = nu(nv(o.cumulative, m) + u)),
            (o.total = S),
            null !== g &&
      ...
      class nL {
        ...
        resetStacks() {
          nb(this.stacks, (t) => {
            nb(t, (e, i) => {
              ny(e.touched) && e.touched < this.stacksTouched
        ...
        renderStackTotals() {
          let t = this.axis,
            ...
            r = (this.stackTotalGroup =
              this.stackTotalGroup || i.g('stack-labels').attr({ zIndex: 6, opacity: 0 }).add())
      ...
      class nB extends r1 {
        drawGraph() {
          ...
          ;[this, ...this.zones].forEach((s, o) => {
            ...
            a
              ? ((a.endX = this.preventGraphAnimation ? null : e.xMap), a.animate({ d: e }))
              : e.length &&
                (s.graph = a =
                  this.chart.renderer
                    .path(e)
              ...
              a &&
                ...
                a[n](r).shadow(
                  t.shadow && nI({ filterUnits: 'userSpaceOnUse' }, nD(t.shadow) ? t.shadow : {})
                )),
      ...
      ;(nB.defaultOptions = nI(r1.defaultOptions, { legendSymbol: 'lineMarker' })),
        ...
        getGraphPath(t) {
            ...
            f = function (i, s, o) {
              ...
              m || f
                ...
                void 0 !== x &&
                  ...
                  h.push({ plotX: e, plotY: null === y ? g : n.getThreshold(y), doCurve: !1 }))
            }
          ...
          for (let o = 0, r = t.length; o < r; ++o)
            a || (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[o].rightNull = void 0),
              ...
              (!i || u) &&
                (u || f(o, o - 1, 'left'),
                (i && !a && u) || (l.push(t[o]), h.push({ x: o, plotX: e, plotY: s })),
                u || f(o, o + 1, 'right'))
      ...
      ;(nX.defaultOptions = nR(nN.defaultOptions, { threshold: 0, legendSymbol: 'areaMarker' })),
        nz(nX.prototype, { singleStacks: !1 }),
        rk.registerSeriesType('area', nX)
      let { line: nF } = rk.seriesTypes,
        { merge: nG, pick: nj } = V
      class nY extends nF {
        getPointSpline(t, e, i) {
          ...
          let p = [
            'C',
            nj(l.rightContX, l.plotX, 0),
            nj(l.rightContY, l.plotY, 0),
            nj(s, n, 0),
            nj(o, h, 0),
            n,
            h,
      ...
      class ht extends r1 {
        animate(t) {
          ...
          t && h
            ? ((d.scaleY = 0.001),
              ...
              l
                ? (d.translateX = (i += a ? -Math.floor(h[0]) : Math.ceil(h[2])) - o.len)
                : (d.translateY = i += a ? Math.ceil(h[0]) : -Math.floor(h[2])),
              s.clipBox && s.setClip(),
              s.group.attr(d))
        ...
        translate() {
          ...
          i.pointPadding && i.crisp && (f = Math.ceil(f)),
            ...
            t.points.forEach(function (s) {
              let o = n8(s.yBottom, u),
                m = 999 + Math.abs(o),
                x = s.plotX || 0,
                y = n0(s.plotY, -m, a.len + m),
                b,
                v = Math.min(y, o),
                k = Math.max(y, o) - v,
                w = d,
              ...
              h &&
                ...
                (s.tooltipPos = e.inverted
                  ...
                  : [
                      ...
                      n0(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop),
                      k,
                    ]),
        ...
        pointAttribs(t, e) {
          let i = this.options,
            ...
            g = t?.isNull && i.nullInteraction ? 0 : (t?.opacity ?? i.opacity ?? 1)
          t &&
            this.zones.length &&
            ((n = t.getZone()),
            ...
            e &&
              t &&
              ((h = (a = n4(i.states[e], (t.options.states && t.options.states[e]) || {}))
                .brightness),
          ...
          t.forEach(function (t) {
            ...
            n9(h) && (null !== t.y || r)
              ? ((e = t.shapeArgs),
                ...
                !l &&
                  ((t.graphic = l = a[t.shapeType](e).add(t.group || i.group)),
                  l &&
                    i.enabledDataSorting &&
                    s.hasRendered &&
                    s.pointCount < n &&
                    (l.attr({ x: t.startXPos }), (d = !0), (c = 'animate'))),
                l && d && l[c](n4(e)),
                s.styledMode ||
                  l[c](i.pointAttribs(t, t.selected && 'select')).shadow(
      ...
      !(function (t) {
        ...
        function i(t, e, i, s, o) {
          let { chart: r, enabledDataSorting: a } = this,
            ...
            c =
              ho(h) &&
              ho(l) &&
              r.isInsidePlot(h, Math.round(l), { inverted: n, paneCoordinates: !0, series: this }),
            ...
            g =
              ...
              (t.series.forceDL ||
                (a && !p) ||
                c ||
                (hp(i.inside, !!this.options.stacking) &&
                  s &&
          ...
          if (g && u) {
            ...
            if (
              ((s = hr({ x: u[0], y: Math.round(u[1]), width: 0, height: 0 }, s || {})),
              'plotEdges' === i.alignTo &&
                this.isCartesian &&
                ((s[n ? 'x' : 'y'] = 0), (s[n ? 'width' : 'height'] = this.yAxis?.len || 0)),
              hr(i, { width: h.width, height: h.height }),
              (f = s),
              a && this.xAxis && !p && this.setDataLabelStartPos(t, e, o, c, f),
              e.align(hd(i, { width: l.width, height: l.height }), !1, s, !1),
            ...
            i.shape && !d && e[o ? 'attr' : 'animate']({ anchorX: u[0], anchorY: u[1] })
          }
          o && a && (e.placed = !1),
            g || (a && !p) ? (e.show(), (e.placed = !0)) : (e.hide(), (e.placed = !1))
        }
        function s() {
        ...
        function r(t) {
          ...
          let i = this,
            ...
            u = g ? hi(s, p, i) : { defer: 0, duration: 0 }
              ...
              t.forEach((t) => {
                ...
                hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                  let c =
                    ...
                    { backgroundColor: p, borderColor: g, distance: u, style: f = {} } = n,
                    m,
                    x,
                    y,
                    b = {},
                    ...
                    w
                  c &&
                    ((x = ho((m = hp(n[t.formatPrefix + 'Format'], n.format)))
                      ? hs(m, t, s)
                      : (n[t.formatPrefix + 'Formatter'] || n.formatter).call(t, n)),
                    (y = n.rotation),
                    !s.styledMode &&
                      ((f.color = hp(n.color, f.color, hl(i.color) ? i.color : void 0, '#000000')),
                      'contrast' === f.color
                        ? ('none' !== p && (w = p),
                          (t.contrastColor = r.getContrast(
                            ('auto' !== w && hl(w) && w) || (hl(h) ? h : '')
                          )),
                          (f.color =
                            w || (!ho(u) && n.inside) || 0 > hg(u || 0) || o.stacking
                              ? t.contrastColor
                              : d))
                        : delete t.contrastColor,
                      o.cursor && (f.cursor = o.cursor)),
                    (b = { r: n.borderRadius || 0, rotation: y, padding: n.padding, zIndex: 1 }),
                    s.styledMode ||
                    ...
                    !v ||
                      (c &&
                        ho(x) &&
                        !!(v.div || v.text?.foreignObject) == !!n.useHTML &&
                        ((v.rotation && n.rotation) || v.rotation === n.rotation)) ||
                      ((v = void 0), (k = !0)),
                    c &&
                      ho(x) &&
                      '' !== x &&
                      ...
                      v &&
                        ...
                        ha(v, 'beforeAddingDataLabel', { labelOptions: n, point: t }),
                        v.added || v.add(e),
                ...
                let l = a.length
                for (; l--; )
                  a[l]?.isActive ? (a[l].isActive = !1) : (a[l]?.destroy(), a.splice(l, 1))
        ...
        function a(t, e, i, s, o, r) {
          ...
          return (
            (m = (i.x || 0) + l + c) < 0 &&
              ('right' === n && u >= 0 ? ((e.align = 'left'), (e.inside = !0)) : (u -= m),
              (x = !0)),
            (m = (i.x || 0) + s.width - l + c) > a.plotWidth &&
              ...
              (x = !0)),
            (m = i.y + l + g) < 0 &&
              ('bottom' === h && f >= 0 ? ((e.verticalAlign = 'top'), (e.inside = !0)) : (f -= m),
              (x = !0)),
        ...
        function n(t, e) {
          ...
          if (hh(t) && !hh(e))
            ...
            if (hh(t) && hh(e)) for (s = Math.max(t.length, e.length); s--; ) i[s] = hd(t[s], e[s])
          } else i = hd(t, e)
          return i
        }
        function h(t) {
      ...
      !(function (t) {
        function e(t, e, i, s, o) {
          ...
          if (d) {
            if (((s = hy(d)), 'allow' !== i.overflow || !1 !== i.crop || !1 !== a.clip)) {
        ...
        t.compose = function (t) {
          hf.compose(hx), hb(hm, 'ColumnDataLabel') && (t.prototype.alignDataLabel = e)
        }
      })(f || (f = {}))
      let hv = f,
      ...
      !(function (t) {
        ;(t.getCenter = function () {
          ...
          let g = [
            hD(r?.[0], '50%'),
            hD(r?.[1], '50%'),
            hD(l && l < 0 ? void 0 : t.size, '100%'),
            hD(d && d < 0 ? void 0 : t.innerSize || 0, '0%'),
          ]
          for (!e.angular || this instanceof r1 || (g[3] = 0), c = 0; c < 4; ++c)
            (p = g[c]),
              (h = c < 2 || (2 === c && /%$/.test(p))),
          ...
          return (
            ...
            hE(this, 'afterGetCenter', { positions: g }),
            g
          )
        }),
          (t.getStartAndEndRadians = function (t, e) {
            ...
            return { start: hO * (i + -90), end: hO * (s + -90) }
          })
      })(m || (m = {}))
      let hN = m,
        { setAnimation: hz } = tU,
        { addEvent: hR, defined: hW, extend: hH, isNumber: hX, pick: hF, relativeLength: hG } = V
      class hj extends oK {
        getConnectorPath(t) {
      ...
      hH(hj.prototype, {
        connectorShapes: {
          ...
          crookedLine: function (t, e, i) {
            ...
            let x = [['M', u, f]]
            return (
              (g ? m <= u && m >= o.x : m >= u && m <= o.x) && x.push(['L', m, f]),
        ...
        animate(t) {
          ...
          t ||
            i.forEach(function (t) {
              ...
              i &&
                o &&
                (i.attr({ r: hq(t.startR, e.center && e.center[3] / 2), start: s, end: s }),
      ...
      !(function (t) {
        ...
        function s() {
          ...
          t.visible &&
                    ...
                    if (x) {
                      if (
                        (g &&
                          ...
                          (void 0 === m.pos
                            ? (S = 'hidden')
                            : ((f = m.size), (M = p.radialDistributionY(i, l)))),
                        d.justify)
                      )
                        w = p.justify(i, l, h, n)
                      else
                      ...
                      if (
                        ...
                        (x.posAttribs = {
                          x: w + (d.x || 0) + ({ left: b, right: -b }[x.alignment] || 0),
                          y: M + (d.y || 0) - v / 2,
                        }),
                        (x.computed.x = w),
                        (x.computed.y = M - k),
                        ...
                        w - (u = l.getBBox().width) < b && 1 === a
                          ? ((t = Math.round(u - w + b)), (c[3] = Math.max(t, c[3])))
                          : w + u > s - b &&
                            0 === a &&
                            ((t = Math.round(w + u - s + b)), (c[1] = Math.max(t, c[1]))),
                          M - f / 2 < 0
                            ? (c[0] = Math.max(Math.round(-M + f / 2), c[0]))
                            : M + f / 2 > o && (c[2] = Math.max(Math.round(M + f / 2 - o), c[2])),
                          (x.sideOverflow = t)
                      }
                    }
                  })
            ...
            (0 === h2(c) || this.verifyDataLabelOverflow(c)) &&
                    ...
                    ;(g = s.connector),
                      a && a.distance > 0
                        ? ((n = !g),
                          ...
                          i.styledMode ||
                            g.attr({ 'stroke-width': r, stroke: o || e.color || '#666666' }),
                          g[n ? 'attr' : 'animate']({ d: e.getConnectorPath(s) }),
        ...
        function r(t) {
          ...
          return (
            !a &&
              ...
              null !== s[1]
                ? (r = h3(r, o, e[2] - Math.max(t[0], t[2])))
                : ((r = h3(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
                    i.thickness
                      ? Math.max(0, r - 2 * i.thickness)
                      : Math.max(0, h8(i.innerSize || 0, r)),
                    r
                  )),
                  this.translate(e),
      ...
      let { pointInPolygon: lt } = y,
        { addEvent: le, getAlignFactor: li, fireEvent: ls, objectEach: lo, pick: lr } = V
      function la(t) {
        let e = t.length,
          i = (t, e) =>
            !(
          ...
          s = (t, e) => {
            for (let i of t) if (lt({ x: i[0], y: i[1] }, e)) return !0
            return !1
          },
          o,
          r,
            ...
            t.oldOpacity !== i &&
              (t.hasClass('highcharts-data-label')
                ? (t[i ? 'removeClass' : 'addClass']('highcharts-data-label-hidden'),
                  ...
                  ls(e, 'afterHideOverlappingLabel'))
                : t.attr({ opacity: i })),
            (t.isOld = !0)),
          s
        )
              ...
              for (let s of i)
                s.visible &&
                  (s.dataLabels || []).forEach((i) => {
                    let o = i.options || {}
                    ;(i.labelrank = lr(o.labelrank, s.labelrank, s.shapeArgs?.height)),
                      (o.allowOverlap ?? Number(o.distance) > 0)
                        ? ((i.oldOpacity = i.opacity), (i.newOpacity = 1), ln(i, t))
                        : e.push(i)
                  })
            }
      ...
      let ll = {
        ...
        { defaultOptions: ld } = tv,
        { noop: lc } = w,
        { addEvent: lp, extend: lg, isObject: lu, merge: lf, relativeLength: lm } = V,
        lx = { radius: 0, scope: 'stack', where: void 0 },
        ly = lc,
        lb = lc
        ...
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          ...
          for (let s of this.points) {
            ...
            if ('roundedRect' === s.shapeType && a) {
              ...
              'end' === g && (p && (d -= u), (c += u)), lg(a, { brBoxHeight: c, brBoxY: d, r: u })
            }
          }
        }
      }
      function lw(t, e) {
        return lu(t) || (t = { radius: t || 0 }), lf(lx, e, t)
      }
      function lM() {
      ...
      !(function (t) {
        function e(t, e) {
          ...
          ;(
            ...
            function () {
              return (
                this.chartWidth <= lL(i.maxWidth, Number.MAX_VALUE) &&
                this.chartHeight <= lL(i.maxHeight, Number.MAX_VALUE) &&
                this.chartWidth >= lL(i.minWidth, 0) &&
                this.chartHeight >= lL(i.minHeight, 0)
              )
            }
        ...
        function i(t, e) {
          ...
          let a = lP(
            ...o.map((t) => lA(i?.rules || [], (e) => e._id === t)).map((t) => t?.chartOptions)
          )
          ...
          o !== n &&
            ...
            o
              ? (((r = lT(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions =
                  !0),
                (this.currentResponsive = { ruleIds: o, mergedOptions: a, undoOptions: r }),
                this.updatingResponsive || this.update(a, t, !0))
              : (this.currentResponsive = void 0))
        }
        t.compose = function (t) {
          let s = t.prototype
          return s.matchResponsiveRule || lC(s, { matchResponsiveRule: e, setResponsive: i }), t
        }
      })(b || (b = {}))
      let lE = b
      ;(w.AST = t6),
        ...
        (w.Legend = au),
        (w.LegendSymbol = rm),
        (w.OverlappingDataLabels = w.OverlappingDataLabels || ll),
        (w.PlotLineOrBand = oa),
        (w.Point = oK),
        (w.Pointer = ra),
        ...
        (w.timers = tB.timers),
        {
          compose: function (t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes('borderRadius')) {
              ...
              lp(t, 'afterColumnTranslate', lk, { order: 9 }),
                lp(s, 'afterTranslate', lM),
