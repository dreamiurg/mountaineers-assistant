      ...
      return (
        ...
        (e.prototype.close = function () {
          j(this.element, this.classNames.openState),
            ...
            (this.isOpen = !1),
            this.isFlipped && (j(this.element, this.classNames.flippedState), (this.isFlipped = !1))
        }),
          ...
          this._store.withTxn(function () {
            ...
            e.forEach(function (e) {
              if ('choices' in e) {
                ...
                var r = G(o, !1)
                c._addChoice(r),
                  r.placeholder && !c._hasNonChoicePlaceholder && (c._placeholderValue = M(r.label))
              }
            }),
              c.unhighlightAll()
          }),
        ...
        if (this._isSelectOneElement) {
          ...
          if (c || a > 1) {
            ...
            c ||
              ...
              ((c = !0),
              r(G({ selected: !0, value: '', label: this._placeholderValue, placeholder: !0 }, !1)))
        }
        c &&
          (i.append(s),
          n.shouldSortItems &&
